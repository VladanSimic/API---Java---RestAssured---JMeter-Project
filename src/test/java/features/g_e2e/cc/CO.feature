...
Feature: Home course of construction
  ...
  @S1 @CO
  Scenario: E2E - CC - CO_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "CO_001" smoke test data from "QuoteCreatorCC" sheet
    ...
    * I rate a quote
    ...
    Then I verify total premium value "$4,156.00"
    * I verify inspection fee value "$350.00"
    * I verify surplus lines broker fee value "$350.00"
    * I verify state mandated assessments value "$145.68"
    * I verify grand total value "$5,001.68"

    Then I verify state mandated assessments "*State Mandated Assessments Include E&S Colorado Premium Tax 3.00% of taxable premium (taxable premium includes inspection fee and surplus lines broker fee)"
    ...
    Then I verify coverage factor and factor value
      ...
      | Non-Wind Premium                                  | Non-Wind Base Rate                                      | 0.302   |
      ...
      | Non-Wind Premium                                  | Base Non-Wind Premium 2 Intermediate                    | 0.231   |
      | Non-Wind Premium                                  | Non-Wind Rate on Line (ROL)                             | 0.231   |
      | Non-Wind Premium                                  | Non-Wind Rate on Line (ROL) Final                       | 0.231   |
      | Non-Wind Premium                                  | Non-Wind Duration Factor                                | 1       |
      | Non-Wind Premium                                  | Base Non-Wind Premium 3 Intermediate                    | 0.231   |
      | Non-Wind Premium                                  | Total Insured Value (TIV)                               | 400000  |
      | Non-Wind Premium                                  | Constant 100                                            | 100     |
      | Non-Wind Premium                                  | Final Non-Wind Premium before Adjustment                | 923.869 |
      | Non-Wind Premium                                  | Final Non-Wind Premium                                  | 923.869 |
      ...
      | Wildfire Premium                                  | Wildfire Base Rate Non-CA                               | 0.214   |
      ...
      | Wildfire Premium                                  | Wildfire Rate on Line (ROL)                             | 0.152   |
      | Wildfire Premium                                  | Wildfire Rate on Line (ROL) Final                       | 0.152   |
      ...
      | Wildfire Premium                                  | Final Wildfire Premium                                  | 609.567 |
      | Reporting - Location Premium Before Adjustments   | Location Premium                                        | 1534    |
      ...
      | Reporting - Location Premium Final ROL            | Reporting - Location Premium Final ROL Premium          | 1534    |
      ...
      | Earthquake Extension                              | EQ Premium                                              | 412     |
      ...
      | Earthquake Extension                              | EQ Rate Per 1000                                        | 1.03    |
      | Total Optional Coverages Premium                  | Additional Optional Coverages                           | 1209.5  |
      | Total Optional Coverages Premium                  | Earthquake Extension                                    | 412     |
      | Total Optional Coverages Premium                  | Earthquake Base Premium                                 | 0       |
      | Total Optional Coverages Premium                  | Total Optional Coverages Premium                        | 1621.5  |
      ...
      | Location Premium                                  | Location Premium                                        | 1534    |
      | Location Premium                                  | Premium after Reset                                     | 1534    |
      | Reporting - Total Location Premium Before         | Reporting - Total Location Premium Before               | 1534    |
      | Reporting - Total Location Premium Before         | Total Optional Coverages Premium                        | 1622    |
      | Total Location Premium                            | HO Total Premium                                        | 4156    |
      | E&S Premium Tax - Policy Premium                  | PHO Premium                                             | 4156    |
      ...
      | Grand Total Premium                               | PHO Premium                                             | 4156    |
      | Grand Total Premium                               | E&S Premium Tax - Policy Premium                        | 124.68  |
      | Grand Total Premium                               | PHO Premium for Tax                                     | 4156    |
      ...
      | State Mandated Assessments                        | E&S Premium Tax - Policy Premium                        | 124.68  |
      | State Mandated Assessments                        | PHO Premium for Tax                                     | 4156    |
    ...
    * I rate a quote
    ...
    Then I verify total annualized premium value "$4,156.00"
    * I verify inspection fee value "$350.00"
    * I verify surplus lines broker fee value "$350.00"
    * I verify state mandated assessments value "$145.68"
    * I verify grand total value "$5,001.68"
    ...
    * I click renewed premium
    ...
    Then I verify total premium value "$4,944.00"
    * I verify inspection fee value "$350.00"
    * I verify surplus lines broker fee value "$0.00"
    * I verify state mandated assessments value "$158.82"
    * I verify grand total value "$5,452.82"
    ...
    Then I verify coverage factor and factor value
      ...
      | Non-Wind Premium                                  | Watchman/Security Guard                                 | 1        |
      | Non-Wind Premium                                  | Maximum Protection Credits                              | 0.85     |
      | Non-Wind Premium                                  | Base Non-Wind Premium 2 Intermediate                    | 0.289    |
      | Non-Wind Premium                                  | Non-Wind Rate on Line (ROL)                             | 0.289    |
      | Non-Wind Premium                                  | Non-Wind Rate on Line (ROL) Final                       | 0.289    |
      | Non-Wind Premium                                  | Non-Wind Duration Factor                                | 1        |
      | Non-Wind Premium                                  | Base Non-Wind Premium 3 Intermediate                    | 0.289    |
      | Non-Wind Premium                                  | Total Insured Value (TIV)                               | 400000   |
      | Non-Wind Premium                                  | Constant 100                                            | 100      |
      | Non-Wind Premium                                  | Final Non-Wind Premium before Adjustment                | 1154.837 |
      | Non-Wind Premium                                  | Final Non-Wind Premium                                  | 1154.837 |
      | Wind Premium                                      | Wind Base Rate                                          | 0        |
      ...
      | Wildfire Premium                                  | Contractor Carries Adequate Liability Coverage          | 0.95     |
      | Wildfire Premium                                  | Subrogation Against Contractor                          | 0.9      |
      | Wildfire Premium                                  | Wildfire Rate on Line (ROL)                             | 0.19     |
      | Wildfire Premium                                  | Wildfire Rate on Line (ROL) Final                       | 0.19     |
      | Wildfire Premium                                  | Wildfire Duration Factor                                | 1        |
      | Wildfire Premium                                  | Total Insured Value (TIV)                               | 400000   |
      | Wildfire Premium                                  | Constant 100                                            | 100      |
      | Wildfire Premium                                  | Final Wildfire Premium                                  | 761.958  |
      | Reporting - Location Premium Before Adjustments   | Location Premium                                        | 1917     |
      | Reporting - Location Premium Before               | Reporting - Location Premium Before                     | 0        |
      | Reporting - Location Premium Before               | Reporting - Premium Adjustment Total - Location Premium | 0        |
      | Reporting - Location Premium Final ROL            | Reporting - Location Premium Final ROL Premium          | 1917     |
      | Reporting - Location Premium Final ROL            | Reporting - Location Premium Final ROL TIV              | 400000   |
      | Reporting - Location Premium Final ROL            | Reporting - Location Premium Final ROL Factor 100       | 100      |
      | Reporting - Location Premium Final ROL            | Reporting - Location Premium Final ROL Term             | 12       |
      | Reporting - Location Premium Final ROL            | Reporting - Location Premium Final ROL Factor 12        | 12       |
      ...
      | Earthquake Extension                              | EQ Premium                                              | 515      |
      | Earthquake Extension                              | Earthquake Ext. Dwelling                                | 400000   |
      | Earthquake Extension                              | Thousand Constant                                       | 1000     |
      | Earthquake Extension                              | Optional Coverage Duration Factor                       | 1        |
      | Earthquake Extension                              | EQ Rate Per 1000                                        | 1.03     |
      ...
      | Total Optional Coverages Premium                  | Earthquake Extension                                    | 515      |
      | Total Optional Coverages Premium                  | Earthquake Base Premium                                 | 0        |
      | Total Optional Coverages Premium                  | Total Optional Coverages Premium                        | 2026.88  |
      | FAC Premium                                       | FAC Premium Value                                       | 1000     |
      | Commission Factor                                 | Commission Value                                        | 1        |
      | Inspection Fee 0                                  | Location Inspection Fee NB                              | 350      |
      | Inspection Fee                                    | Location Inspection Fee                                 | 0        |
      | Location Premium                                  | Location Premium                                        | 1917     |
      | Location Premium                                  | Premium after Reset                                     | 1917     |
      | Reporting - Total Location Premium Before         | Reporting - Total Location Premium Before               | 1917     |
      | Reporting - Total Location Premium Before         | Total Optional Coverages Premium                        | 2027     |
      | Total Location Premium                            | HO Total Premium                                        | 4944     |
      | E&S Premium Tax - Policy Premium                  | PHO Premium                                             | 4944     |
      | E&S Premium Tax - Policy Premium                  | Tax Percentage % - E&S Tax                              | 0.03     |
      | E&S Premium Tax - Inspection Fee 0                | Location Inspection Fee                                 | 350      |
      | E&S Premium Tax - Inspection Fee 0                | Tax Percentage % - E&S Tax                              | 0.03     |
      | E&S Premium Tax - Inspection Fee                  | E&S Premium Tax - Inspection Fee 0                      | 0        |
      | Grand Total Premium                               | PHO Premium                                             | 4944     |
      | Grand Total Premium                               | E&S Premium Tax - Policy Premium                        | 148.32   |
      | Grand Total Premium                               | PHO Premium for Tax                                     | 4944     |
      | Grand Total Premium                               | Tax Percentage % - E&S Tax                              | 0.03     |
      | Grand Total Premium                               | E&S Premium Tax - Inspection Fee                        | 10.5     |
      | Grand Total Premium                               | PHO Inspection Fee for Tax                              | 350      |
      | Grand Total Premium                               | Tax Percentage % - Inspection Fee                       | 0.03     |
      ...
      | Grand Total Premium                               | Inspection Fee                                          | 350      |
      | Grand Total Premium                               | Number of Risk Locations                                | 1        |
      | State Mandated Assessments                        | E&S Premium Tax - Policy Premium                        | 148.32   |
      | State Mandated Assessments                        | PHO Premium for Tax                                     | 4944     |
      | State Mandated Assessments                        | Tax Percentage % - E&S Tax                              | 0.03     |
      | State Mandated Assessments                        | E&S Premium Tax - Inspection Fee                        | 10.5     |
      | State Mandated Assessments                        | PHO Inspection Fee for Tax                              | 350      |
      | State Mandated Assessments                        | Tax Percentage % - Inspection Fee                       | 0.03     |
