...
Feature: Home course of construction
  ...
  @S1 @VA
  Scenario: E2E - CC - VA_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "VA_001" smoke test data from "QuoteCreatorCC" sheet
