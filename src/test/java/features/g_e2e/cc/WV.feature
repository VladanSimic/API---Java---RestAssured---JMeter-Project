...
Feature: Home course of construction
  ...
  @S1 @WV
  Scenario: E2E - CC - WV_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "WV_001" smoke test data from "QuoteCreatorCC" sheet
