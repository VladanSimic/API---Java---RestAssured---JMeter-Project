...
Feature: Home course of construction
  ...
  @S1 @NH
  Scenario: E2E - CC - NH_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "NH_001" smoke test data from "QuoteCreatorCC" sheet
