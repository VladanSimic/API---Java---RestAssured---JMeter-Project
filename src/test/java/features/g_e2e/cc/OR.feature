...
Feature: Home course of construction
  ...
  @S1 @OR
  Scenario: E2E - CC - OR_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "OR_001" smoke test data from "QuoteCreatorCC" sheet
