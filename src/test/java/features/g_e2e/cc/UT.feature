...
Feature: Home course of construction
  ...
  @S1 @UT
  Scenario: E2E - CC - UT_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "UT_001" smoke test data from "QuoteCreatorCC" sheet
