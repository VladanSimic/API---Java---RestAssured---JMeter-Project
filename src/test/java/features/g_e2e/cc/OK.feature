...
Feature: Home course of construction
  ...
  @S1 @OK
  Scenario: E2E - CC - OK_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "OK_001" smoke test data from "QuoteCreatorCC" sheet
