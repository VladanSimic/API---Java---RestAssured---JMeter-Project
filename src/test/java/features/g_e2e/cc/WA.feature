...
Feature: Home course of construction
  ...
  @S1 @WA
  Scenario: E2E - CC - WA_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "WA_001" smoke test data from "QuoteCreatorCC" sheet
