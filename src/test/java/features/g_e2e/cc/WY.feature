...
Feature: Home course of construction
  ...
  @S1 @WY
  Scenario: E2E - CC - WY_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "WY_001" smoke test data from "QuoteCreatorCC" sheet
