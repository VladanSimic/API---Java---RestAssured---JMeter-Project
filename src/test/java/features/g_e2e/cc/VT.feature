...
Feature: Home course of construction
  ...
  @S1 @VT
  Scenario: E2E - CC - VT_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "VT_001" smoke test data from "QuoteCreatorCC" sheet
