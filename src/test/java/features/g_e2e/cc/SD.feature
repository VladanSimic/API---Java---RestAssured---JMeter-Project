...
Feature: Home course of construction
  ...
  @S1 @SD
  Scenario: E2E - CC - SD_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "SD_001" smoke test data from "QuoteCreatorCC" sheet
