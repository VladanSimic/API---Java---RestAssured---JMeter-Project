...
Feature: Home course of construction
  ...
  @S1 @TN
  Scenario: E2E - CC - TN_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "TN_001" smoke test data from "QuoteCreatorCC" sheet
