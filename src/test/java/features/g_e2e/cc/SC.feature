...
Feature: Home course of construction
  ...
  @S1 @SC
  Scenario: E2E - CC - SC_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "SC_001" smoke test data from "QuoteCreatorCC" sheet
