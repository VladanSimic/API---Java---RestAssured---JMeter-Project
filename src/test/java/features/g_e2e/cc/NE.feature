...
Feature: Home course of construction
  ...
  @S1 @NE
  Scenario: E2E - CC - NE_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "NE_001" smoke test data from "QuoteCreatorCC" sheet
    ...
    * I verify state mandated assessments value "$398.28"
    * I verify grand total value "$14,024.28"


    Then I verify state mandated assessments "*State Mandated Assessments Include E&S Nebraska Premium Tax 3.00% of taxable premium (taxable premium includes inspection fee but DOES NOT include surplus lines broker fee)"
    ...
    Then I verify coverage factor and factor value
      ...
      | Grand Total Premium                               | E&S Premium Tax - Policy Premium                        | 387.78    |
      ...
      | State Mandated Assessments                        | E&S Premium Tax - Policy Premium                        | 387.78    |
    ...
    * I verify state mandated assessments value "$487.71"
    * I verify grand total value "$16,744.71"
    ...
    Then I verify coverage factor and factor value
      ...
      | Grand Total Premium                               | E&S Premium Tax - Policy Premium                        | 477.21    |
      ...
      | Grand Total Premium                               | Inspection Fee                                          | 350       |
      | Grand Total Premium                               | Number of Risk Locations                                | 1         |
      | State Mandated Assessments                        | E&S Premium Tax - Policy Premium                        | 477.21    |
