...
Feature: Home course of construction
  ...
  @S1 @PA
  Scenario: E2E - CC - PA_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "PA_001" smoke test data from "QuoteCreatorCC" sheet
