...
Feature: Home course of construction
  ...
  @S1 @NY
  Scenario: E2E - CC - NY_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "NY_001" smoke test data from "QuoteCreatorCC" sheet
