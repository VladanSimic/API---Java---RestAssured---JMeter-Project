@CourseOfConstruction @E2ECC
Feature: Home course of construction

  @S1 @TX
  Scenario: E2E - CC - TX_001 - New Business - Endorsement - Policy Extension - Cancellation - Reinstatement - Roll Forward

    Given I use "TX_001" smoke test data from "QuoteCreatorCC" sheet
...
#  @S2 @FL
#  Scenario: E2E - CC - "FL_001" - New Business - Cancellation - New Business Rewrite - Endorsement - Policy Extension - Out of Sequence Endorsement
#
