@US40579 @TC97832 @TC97833 @US @AR @PersonalAuto @Auto @PA @PCRegression @2024 @JUNE @UI @P1 @PCTeam2Regression
Feature: US40579: AR Auto 3.1 - Forms

  @NB @NewBusiness
  Scenario: AR Auto 3.1 - Forms - New Business

    Given I use "AR_014" regression test data from "QuoteCreatorPA" sheet
  ...
  Scenario: AR Auto 3.1 - Forms - Pre-Bind
