@US40581 @TC82985 @TC84192 @US @NM @PersonalAuto @Auto @PA @PCRegression @2024 @JUNE @UI @PCTeam2Regression
Feature: US40581: NM Auto 3.1

  @NB @NewBusiness
  Scenario: NM Auto 3.1 - UI/UW referrals- New Business

    Given I use "NM_014" regression test data from "QuoteCreatorPA" sheet
  ...
  Scenario: NM Auto 3.1 - UI/UW referrals - Day Prior New Business
