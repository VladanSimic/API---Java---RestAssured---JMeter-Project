@US44556 @TC88320 @US @OK @PersonalAuto @Auto @PA @PCRegression @2024 @OCT @Forms @P3 @PCTeam2Regression
Feature: US44556: [Continued] OK Auto Base Rate, Factors, Structural

  @NB @NewBusiness
  Scenario: OK Auto Base Rate, Factors, Structural - New Business
    ...
    * I rate a quote
    ...
    Then I validate premium details page table
      ...
      |                              | Medical Payments (Collection)    | Base Rate - Collector                | 54          | +      |
      | 2016 Tiffin Motorhomes Motor | Bodily Injury                    | Base Rate - Misc                     | 732         | +      |
      | 2016 Tiffin Motorhomes Motor | Property Damage                  | Base Rate - Misc                     | 400         | +      |
      | 2016 Tiffin Motorhomes Motor | Medical Payments                 | Base Rate - Misc                     | 54          | +      |
      | 2016 Tiffin Motorhomes Motor | Uninsured Motorists (CSL)        | Base Rate - Misc                     | 296         | +      |
      | 2016 Tiffin Motorhomes Motor | Comprehensive                    | Base Rate - Misc                     | 142         | +      |
      | 2016 Tiffin Motorhomes Motor | Collision                        | Base Rate - Misc                     | 475         | +      |
      | 2009 Mitsubishi RAIDER       | Bodily Injury                    | Base Rate 3.1                        | 732         | +      |
      | 2010 Ford EXPEDITION         | Bodily Injury                    | Base Rate 3.1                        | 732         | +      |
      | 2010 Ford EXPEDITION         | Property Damage                  | Base Rate 3.1                        | 400         | +      |
      | 2009 Mitsubishi RAIDER       | Property Damage                  | Base Rate 3.1                        | 400         | +      |
      | 2010 Ford EXPEDITION         | Medical Payments                 | Base Rate 3.1                        | 54          | +      |
      | 2009 Mitsubishi RAIDER       | Medical Payments                 | Base Rate 3.1                        | 54          | +      |
      | 2010 Ford EXPEDITION         | Uninsured Motorists (CSL)        | Base Rate 3.1                        | 296         | +      |
      | 2009 Mitsubishi RAIDER       | Uninsured Motorists (CSL)        | Base Rate 3.1                        | 296         | +      |
      | 2009 Mitsubishi RAIDER       | Comprehensive Without Full Glass | Base Rate 3.1                        | 142         | +      |
      | 2010 Ford EXPEDITION         | Comprehensive                    | Base Rate 3.1                        | 142         | +      |
      | 2010 Ford EXPEDITION         | Collision                        | Base Rate 3.1                        | 475         | +      |
      | 2009 Mitsubishi RAIDER       | Collision                        | Base Rate 3.1                        | 475         | +      |
