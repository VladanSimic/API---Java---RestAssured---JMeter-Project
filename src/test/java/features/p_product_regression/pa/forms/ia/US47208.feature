@US47208 @US @IA @PersonalAuto @Auto @PA @PCRegression @2025 @January @Forms
Feature: US47208 - IA Auto Special Provisions Form

  @NB @END @RN @NewBusiness @Endorsement @Renewal
  Scenario: IA Auto Special Provisions Forms - NB/END/RN
  ...
  Scenario: IA Auto Special Provisions Forms - Renewal Conversion
  ...
  Scenario: IA Auto Special Provisions Forms - Day Before PD
  ...
  Scenario: IA Auto Special Provisions Forms - Day Before RB
  ...
  Scenario: IA Auto Special Provisions Forms - Rewrite
  ...
  Scenario: IA Auto Special Provisions Forms - Reinstatement
  ...
  Scenario: IA Auto Special Provisions Forms - NB/END PreProd
