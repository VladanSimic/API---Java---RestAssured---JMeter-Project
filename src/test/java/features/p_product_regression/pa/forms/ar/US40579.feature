@US40579 @US @AR_FORMS @PersonalAuto @Auto @PA @PCRegression @2024 @JUNE @Forms @PCTeam2_PA_P1Regression
Feature: US40579: AR Auto 3.1 - Forms

  @NB @NewBusiness
  Scenario: AR Auto 3.1 - Forms - New Business

    Given I use "AR_013" regression test data from "QuoteCreatorPA" sheet
...
#      | Auto Package - Additional Insured -Test Name |
 ...
 @DayPrior  @NB @NewBusiness
  Scenario: AR Auto 3.1 - Forms - Day Prior New Business
...
#      | Auto Package - Additional Insured -Test Name |
  ...
  @PreBindForms
  Scenario: AR Auto 3.1 - Forms - PreBindForms
