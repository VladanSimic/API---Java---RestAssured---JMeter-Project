@US45849 @TC91513 @US @MN @PersonalAuto @Auto @PA @PCRegression @2024 @DEC @Forms @P2 @PCTeam2Regression
Feature: US45849: [Continued] MN Auto - Full Glass Changes - Forms

  @NB @NewBusiness
  Scenario: MN Auto - Full Glass Coverage - Forms - New Business

    Given I use "MN_014" regression test data from "QuoteCreatorPA" sheet
    ...
    * I set additional vehicles for NB
      ...
      | Private Passenger      | No       | WBAGV8C02NCH01929 | M850       | BMW               | 2022 | 11,000  | 10,000      | 10,000      | without Full Glass |             |
