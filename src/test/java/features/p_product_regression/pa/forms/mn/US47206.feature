@US47206 @US @MN @PersonalAuto @Auto @PA @PCRegression @2025 @January @Forms
Feature: US47206 - MN Auto Special Provisions Form

  @NB @END @RN @NewBusiness @Endorsement @Renewal
  Scenario: MN Auto Special Provisions Forms - NB/END/RN

    Given I use "MN_001" regression test data from "QuoteCreatorPA" sheet
  ...
  Scenario: MN Auto Special Provisions Forms - Renewal Conversion
  ...
  Scenario: MN Auto Special Provisions Forms - Day Before PD
  ...
  Scenario: MN Auto Special Provisions Forms - Day Before RB
  ...
  Scenario: MN Auto Special Provisions Forms - Rewrite
  ...
  Scenario: MN Auto Special Provisions Forms - Reinstatement
  ...
  Scenario: MN Auto Special Provisions Forms - NB/END PreProd
