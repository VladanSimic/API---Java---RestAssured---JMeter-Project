@US44550 @TC88352 @TC88354 @US @VT @PersonalAuto @Auto @PA @PCRegression @2024 @OCT @Forms @P2 @PCTeam2Regression
Feature: US44550: [Continued] VT Auto Full Glass Coverage - Forms

  @NB @NewBusiness
  Scenario: VT Auto - Full Glass Coverage - Forms - New Business

    Given I use "VT_014" regression test data from "QuoteCreatorPA" sheet
    ...
    * I set additional vehicles for NB
      ...
      | Private Passenger      | No       | WAU92BF22RN025744 | A6         | AUDI              | 2024 | 13,000  | No Coverage | No Coverage | 150  | No Coverage        | No Coverage |
  ...
  Scenario: VT Auto - Full Glass Coverage - Forms - Renewal Conversion
    ...
    * I set additional vehicles for NB
      ...
      | Private Passenger      | No       | 3VWC57BU4MM035678 | JETTA      | VOLKSWAGEN        | 2021 | 11,000  | 2,500       | 2,500       | 150  | without Full Glass |             |
      | Private Passenger      | No       | 19UDE4H69PA027805 | INTEGRA    | ACURA             | 2023 | 12,000  | 1,000       | 1,000       | 150  | with Full Glass    |             |
      | Private Passenger      | No       | 5J8TC2H37KL011921 | RDX        | Acura             | 2019 | 13,000  | No Coverage | No Coverage | 150  | No Coverage        | No Coverage |
      | Antique Collectors Car | No       | 242076P339510     | GTO        | Ponatic           | 1966 | 11,000  | 1,000       | 1,000       | 150  | without Full Glass | No Coverage |
      | Exotic Collectors Car  | No       | 242076P3395221122 | GTO        | FORD              | 1996 | 15,900  | No Coverage | No Coverage | 150  | No Coverage        | No Coverage |
      | Motor Home             | No       | 5VBBA37A8GA116483 | Motor Home | Tiffin Motorhomes | 2016 | 13,000  | 500         | 500         | 150  | with Full Glass    | No Coverage |
    And I navigate to quotes page
  ...
  Scenario: VT Auto - Full Glass Coverage - Forms - Pre-Bind
