@US50880  @TC100422 @US @TX @ExcessLiability @EX @PCRegression @2025 @APR @UI @Forms @P1 @PCTeam2Regression
Feature:US50880: [Continued] TX - Excess 3.0 - UI, UW Referrals & Forms

  @NB @NewBusiness
  Scenario: TX Excess 3.0 - UI and UW Referrals & Forms - NB

    Given I use "TX_002" regression test data from "QuoteCreatorEX" sheet
  ...
  Scenario: TX Excess 3.0 - UI and UW Referrals & Forms - NB PreBind
