@US45712  @TC92098 @TC92100 @US @CT @ExcessLiability @EX @PCRegression @2024 @DEC @UI @P1 @PCTeam2Regression
Feature: US45712: [Continued] CT Excess 3.0 - UI and UW Referrals & Forms

  @NB @NewBusiness
  Scenario: CT Excess 3.0 - UI and UW Referrals - NB
...
#    * I set "Additional_Insured_Num" to "0"
    ...
    * I verify that the "Exclude" element is "Displayed" on the UI
    * I navigate to Property Information page
...
#  Scenario: CT Excess 3.0 - UI and UW Referrals - END
#
#    Given I use "CT_003" regression test data from "QuoteCreatorEX" sheet
#    When I am logged in to Pure as "P81" unless is PROD then "A1"
#    Then I load random user data
#    * I set "Effective_Date" to "01/01/2025"
...
#    * I issue an endorsement
  ...
  Scenario: CT Excess 3.0 - UI and UW Referrals - RC
...
#    * I set "Additional_Insured_Num_RNW" to "0"
  ...
  Scenario: CT Excess 3.0 - UI and UW Referrals - Pre-Bind Forms
