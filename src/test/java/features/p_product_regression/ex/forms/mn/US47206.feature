@US47206 @US @MN @ExcessLiability @EX @PCRegression @2025 @January @Forms
Feature: US47206 - MN Excess Liability Special Provisions Form

  @NB @END @RN @NewBusiness @Endorsement @Renewal
  Scenario: MN Excess Liability Special Provisions Forms - NB/END/RN

    Given I use "MN_001" regression test data from "QuoteCreatorEX" sheet
  ...
  Scenario: MN Excess Liability Special Provisions Forms - Renewal Conversion
  ...
  Scenario: MN Excess Liability Special Provisions Forms - Day Before PD
  ...
  Scenario: MN Excess Liability Special Provisions Forms - Day Before RB
  ...
  Scenario: MN Excess Liability Special Provisions Forms - Rewrite
  ...
  Scenario: MN Excess Liability Special Provisions Forms - Reinstatement
  ...
  Scenario: MN Excess Liability Special Provisions Forms - NB/END PreProd
