@US53132 @TC105399 @US @CA @ExcessLiability @EX @PCRegression @2025 @JUNE @UI @P1 @PCTeam2Regression
Feature: US53132: [Continued] CA - Excess 3.0 changes for UI, UW Referrals and Forms

  @NB @NewBusiness
  Scenario: CA Excess 3.0 - UI, UW Referrals & Forms - Existing - NB

    Given I use "CA_002" regression test data from "QuoteCreatorEX" sheet
