@US47206 @US @MN @Homeowners @HO @PCRegression @2025 @January @Forms
Feature: US47206 - MN Homeowners Special Provisions Form

  @NB @END @RN @NewBusiness @Endorsement @Renewal
  Scenario: MN Homeowners Special Provisions Forms - NB/END/RN
  ...
  Scenario: MN Homeowners Special Provisions Forms - Renewal Conversion
  ...
  @NB @END @NewBusiness @Endorsement @DayBefore @DayBeforePD @PreProd @PreProd
  Scenario: MN Homeowners Special Provisions Forms - Day Before PD
  ...
  Scenario: MN Homeowners Special Provisions Forms - Day Before RB
  ...
  Scenario: MN Homeowners Special Provisions Forms - Rewrite
  ...
  Scenario: MN Homeowners Special Provisions Forms - Reinstatement
  ...
  Scenario: MN Homeowners Special Provisions Forms - NB/END PreProd
