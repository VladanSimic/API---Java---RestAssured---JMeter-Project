@US47208 @US @IA @Homeowners @HO @PCRegression @2025 @January @Forms
Feature: US47208 - IA Homeowners Special Provisions Form

  @NB @END @RN @NewBusiness @Endorsement @Renewal
  Scenario: IA Homeowners Special Provisions Forms - NB/END/RN
  ...
  Scenario: IA Homeowners Special Provisions Forms - Renewal Conversion
  ...
  Scenario: IA Homeowners Special Provisions Forms - Day Before PD
  ...
  Scenario: IA Homeowners Special Provisions Forms - Day Before RB
  ...
  Scenario: IA Homeowners Special Provisions Forms - Rewrite
  ...
  Scenario: IA Homeowners Special Provisions Forms - Reinstatement
  ...
  Scenario: IA Homeowners Special Provisions Forms - NB/END PreProd
