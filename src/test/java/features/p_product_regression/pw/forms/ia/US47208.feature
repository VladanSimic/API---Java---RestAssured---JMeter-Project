@US47208 @US @IA @PersonalWatercraft @Watercraft @PW @PCRegression @2025 @January @Forms
Feature: US47208 - IA Personal Watercraft Special Provisions Form

  @NB @END @RN @NewBusiness @Endorsement @Renewal
  Scenario: IA Personal Watercraft Special Provisions Forms - NB/END/RN
  ...
  Scenario: IA Personal Watercraft Special Provisions Forms - Renewal Conversion
  ...
  Scenario: IA Personal Watercraft Special Provisions Forms - Day Before PD
  ...
  Scenario: IA Personal Watercraft Special Provisions Forms - Day Before RB
  ...
  Scenario: IA Personal Watercraft Special Provisions Forms - Rewrite
  ...
  Scenario: IA Personal Watercraft Special Provisions Forms - Reinstatement
  ...
  @NB @END @RN @NewBusiness @Endorsement @PreProdNew @2
  Scenario: IA Personal Watercraft Special Provisions Forms - NB/END PreProd
