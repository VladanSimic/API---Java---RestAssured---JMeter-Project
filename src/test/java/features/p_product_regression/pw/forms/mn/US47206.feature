@US47206 @US @MN @PersonalWatercraft @Watercraft @PW @PCRegression @2025 @January @Forms
Feature: US47206 - MN Personal Watercraft Special Provisions Form

  @NB @END @RN @NewBusiness @Endorsement @Renewal
  Scenario: MN Personal Watercraft Special Provisions Forms - NB/END/RN

    Given I use "MN_001" regression test data from "QuoteCreatorPW" sheet
  ...
  Scenario: MN Personal Watercraft Special Provisions Forms - Renewal Conversion

    Given I use "MN_001" regression test data from "QuoteCreatorPW" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
    * I set "Effective_Date" to "04/09/2024"
    And I navigate to quotes page
    Then I initiate a new quote
    And I create a new "PW" quote
    * I rate a quote
  ...
  Scenario: MN Personal Watercraft Special Provisions Forms - Day Before PD
  ...
  Scenario: MN Personal Watercraft Special Provisions Forms - Day Before RB

    Given I use "MN_001" regression test data from "QuoteCreatorPW" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
    * I set "Effective_Date" to "04/08/2024"
    And I navigate to quotes page
    Then I initiate a new quote
    And I create a new "PW" quote
    * I rate a quote
  ...
  Scenario: MN Personal Watercraft Special Provisions Forms - Rewrite
  ...
  Scenario: MN Personal Watercraft Special Provisions Forms - Reinstatement
  ...
  Scenario: MN Personal Watercraft Special Provisions Forms - NB/END PreProd
