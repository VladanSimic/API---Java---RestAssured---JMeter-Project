@US47210 @US @FL @Collection @CO @PCRegression @2025 @January @Rating @FIGA
Feature: US47210 - FL FIGA 1% Collection

  @NB @END @RN @NewBusiness @Endorsement @Renewal
  Scenario: FL Collection FIGA 1% - NB/END/RN
    ...
    * I think for 5 to 6 seconds
    ...
    Then I validate premium details page table
      ...
      |              | Collection Grand Total Premium                               | Florida Insurance Guaranty Association Assessment Factor  | 0          | +      |
      |              | Collection Grand Total Premium                                  | Florida Insurance Guaranty Association Assessment Factor 2| /          | +      |
    ...
    * I set "Risk_Location_Fire_Alarm" to "Yes"
    * I fill out CO risk location characteristics block
  ...
  Scenario: FL Collection FIGA 1% - Renewal Conversion
    Given I use "FL_001" regression test data from "QuoteCreatorCO" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
  ...
  Scenario: FL Collection FIGA 1% - Day Prior PD Filling
    Given I use "FL_001" regression test data from "QuoteCreatorCO" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
    ...
    * I navigate to premium details page
    Then I validate premium details page table
      ...
      |              | Florida Insurance Guaranty Association Assessment 2.1| !Florida Insurance Guaranty Association Assessment Factor 2| 0.01       | *      |
      |              | Collection Grand Total Premium                                 | Florida Insurance Guaranty Association Assessment Factor   | 0          | +      |
      |              | Collection Grand Total Premium                                 | Florida Insurance Guaranty Association Assessment Factor 2 | 0          | +      |
    And I return to premium summary page
    * I navigate to underwriting referrals page
    * I accept underwriting referrals
    Then I bind a quote
  ...
  Scenario: FL Collection FIGA 1% - Rewrite
    Given I use "FL_001" regression test data from "QuoteCreatorCO" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
    * I set "Effective_Date" to "01/17/2025"
  ...
  Scenario: FL Collection FIGA 1% - Day Prior RB
    Given I use "FL_001" regression test data from "QuoteCreatorCO" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
  ...
  Scenario: FL Collection FIGA 1% - PreProd
    Given I use "FL_001" regression test data from "QuoteCreatorCO" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
    * I set "Effective_Date" to "01/18/2025"
