@US47206 @US @MN @Collection @CO @PCRegression @2025 @January @Forms
Feature: US47206 - MN Collection Special Provisions Form

  @NB @END @RN @NewBusiness @Endorsement @Renewal
  Scenario: MN Collection Special Provisions Forms - NB/END/RN

    Given I use "MN_001" regression test data from "QuoteCreatorCO" sheet
  ...
  Scenario: MN Collection Special Provisions Forms - Renewal Conversion
  ...
  Scenario: MN Collection Special Provisions Forms - Day Before PD
  ...
  Scenario: MN Collection Special Provisions Forms - Day Before RB
  ...
  Scenario: MN Collection Special Provisions Forms - Rewrite
  ...
  Scenario: MN Collection Special Provisions Forms - Reinstatement
  ...
  Scenario: MN Collection Special Provisions Forms - NB/END PreProd
