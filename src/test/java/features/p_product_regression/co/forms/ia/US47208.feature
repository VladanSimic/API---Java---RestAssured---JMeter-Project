@US47208 @US @IA @Collection @CO @PCRegression @2025 @January @Forms
Feature: US47208 - IA Collection Special Provisions Form

  @NB @END @RN @NewBusiness @Endorsement @Renewal
  Scenario: IA Collection Special Provisions Forms - NB/END/RN
  ...
  Scenario: IA Collection Special Provisions Forms - Renewal Conversion
    Given I use "IA_001" regression test data from "QuoteCreatorCO" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
  ...
  Scenario: IA Collection Special Provisions Forms - Day Before PD
    Given I use "IA_001" regression test data from "QuoteCreatorCO" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
  ...
  Scenario: IA Collection Special Provisions Forms - Day Before RB
    Given I use "IA_001" regression test data from "QuoteCreatorCO" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
  ...
  Scenario: IA Collection Special Provisions Forms - Rewrite
    Given I use "IA_001" regression test data from "QuoteCreatorCO" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
    * I set "Effective_Date" to "02/14/2025"
  ...
  Scenario: IA Collection Special Provisions Forms - Reinstatement
    Given I use "IA_001" regression test data from "QuoteCreatorCO" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
    * I set "Effective_Date" to "02/15/2025"
  ...
  Scenario: IA Collection Special Provisions Forms - NB/END PreProd
    Given I use "IA_001" regression test data from "QuoteCreatorCO" sheet
    When I am logged in to Pure as "P81" unless is PROD then "A1"
    Then I load random user data
    * I set "Effective_Date" to "02/15/2025"
