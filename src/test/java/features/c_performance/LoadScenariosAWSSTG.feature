...
#    * I think for 2 to 5 seconds and I keep navigating to policies and customers page 180 times
    * I think for 2 to 5 seconds and I keep navigating to policies and customers page 1 times
...
#    * I think for 5 to 10 seconds and i keep navigating to transactions and endorsements page for 360 times for "<policyID>"
    * I think for 5 to 10 seconds and i keep navigating to transactions and endorsements page for 1 times for "<policyID>"
...
#    And I think for 9 to 20 seconds and i keep logging in as "<user>" for 360 times
    And I think for 9 to 20 seconds and i keep logging in as "<user>" for 1 times
...
#    * I think for 4 to 10 seconds and i keep clicking customer summary tab for 600 times
    * I think for 4 to 10 seconds and i keep clicking customer summary tab for 1 times
    ...
    Examples:
      ...
      | 8      | P678 | 742311463319 |
      | 9      | P679 | 310566837419 |
      | 10     | P680 | 742014270269 |
      | 11     | P681 | 8098634819   |
      | 12     | P682 | 741812622679 |
      | 13     | P683 | 514658447219 |
      | 14     | P684 | 738284354589 |
      | 15     | P685 | 24794738219  |
      | 16     | P686 | 737628360689 |
      | 17     | P687 | 20174671819  |
      | 18     | P688 | 740077054139 |
      | 19     | P689 | 525371740619 |
      | 20     | P690 | 740208780449 |
...
#    * I think for 40 to 60 seconds an I keep navigating to policy image page for 150 times
    * I think for 40 to 60 seconds an I keep navigating to policy image page for 1 times
...
#    And I think for 5 to 6 seconds and i keep navigating to quote summary page for 900 times for "<accountID>"
    And I think for 5 to 6 seconds and i keep navigating to quote summary page for 1 times for "<accountID>"
