Feature: Excess liability line of business
  As a user I should be able to create excess liability line of business quotes and policies.

  @ExcessLiability @Smoke @FL @SmokeJenkins
  Scenario: Smoke Excess Liability - FL_001
...
#    And I select address state
  ...
  @ExcessLiability @Smoke @TX @SmokeJenkins
  Scenario: Smoke Excess Liability - TX_001
  As a user I should be able to create and rate excess liability line of business quote for TX state,
  process it into a policy and add endorsement and renewal transactions to it.
...
#    And I select address state
  ...
  @ExcessLiability @TrueUpSmoke @NewBusiness
  Scenario Outline: TrueUp Smoke Excess Liability
  As a user I should be able to create and rate excess liability line of business quote for FL state,
  process it into a policy and add endorsement and renewal transactions to it.
