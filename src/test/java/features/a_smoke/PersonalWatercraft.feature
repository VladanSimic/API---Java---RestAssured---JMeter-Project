Feature: Personal watercraft line of business
  As a user I should be able to create personal watercraft line of business quotes and policies.

  @PersonalWatercraft @Smoke @NY
  Scenario: Smoke Personal watercraft - "NY_001"
  As a user I should be able to create and rate personal watercraft line of business quote for NY state,
  process it into a policy and add endorsement and renewal transactions to it.

    Given I use "NY_001" smoke test data from "QuoteCreatorPW" sheet
...
#    And I select address state
  ...
  @PersonalWatercraft @Smoke @CA
  Scenario: Smoke Personal watercraft - "CA_001"
  As a user I should be able to create and rate personal watercraft line of business quote for CA state,
  process it into a policy and add endorsement and renewal transactions to it.

    Given I use "CA_001" smoke test data from "QuoteCreatorPW" sheet
    And I load random user data
...
#    And I select address state
  ...
  @PersonalWatercraft @Smoke @TX
  Scenario: Smoke Personal watercraft - "TX_001"
  As a user I should be able to create and rate personal watercraft line of business quote for TX state,
  process it into a policy and add endorsement and renewal transactions to it.
...
#    And I select address state
  ...
  @PersonalWatercraft @TrueUpSmoke @NewBusiness
  Scenario Outline: TrueUp Personal watercraft new business
