@FullRegression @OFAC @Integration @CourseOfConstruction @COC @CC
Feature: OFAC Suite - Course of Construction
  As a user I should be able to verify OFAC positive and negative on all transactions for Homeowners

  @NamedInsured
  Scenario Outline: <TC_ID> OFAC - Course of Construction Named Insured
    ...
    * I click review referrals
    ...
    And I navigate to transactions or endorsements
    And I initiate a policy extension
    * I navigate to policy image page
    * I navigate via action button next
    * I set project description to "Test"
    * I review changes
  ...
  @OtherEntity
  Scenario Outline: <TC_ID> OFAC - Course of Construction Other Entity
    ...
    * I set the please provide the principal beneficial owners name or employees 0 first name to "Pete"
    * I set the please provide the principal beneficial owners name or employees 0 last name to "Stevenson"
  ...
  @AdditionalInterests
  Scenario Outline: <TC_ID> OFAC - Course of Construction Additional Interests
    ...
    * I set "First_Name" to "Milenko"
    * I set "Last_Name" to "Miletic"
    And I navigate to quotes page
    Then I initiate a new quote
    * I create a new "CC" quote
    * I rate a quote
