@FullRegression @OFAC @Integration @Homeowners @HO
Feature: OFAC Suite - Homeowners
  As a user I should be able to verify OFAC positive and negative on all transactions for Homeowners

  @NamedInsured
  Scenario Outline: <TC_ID> OFAC - Homeowners Named Insured

    Given I use "<TC_ID>" regression test data from "QuoteCreatorHO" sheet
    When I am logged in to Pure as "P70" unless is PROD then "A1"
    ...
    * I verify if there are <NUM_OF_REFERRALS_ON_RENEWAL> OFAC referrals
    ...
    Examples:
      ...
      | FL_001 | Steve      | Black     | Negative | 1                           |

  @LLC
  Scenario Outline: <TC_ID> OFAC - Homeowners LLC
    ...
    * I set the named insured type to "Limited Liability Company (LLC)"
    * I set name of resident to "TestCO LLC"
    ...
    * I set the LLC trust questionnaire block legal entity type to "LLC"
    * I click on the footer
  ...
  @OtherEntity
  Scenario Outline: <TC_ID> OFAC - Homeowners Other Entity
  ...
  @AdditionalInterests
  Scenario Outline: <TC_ID> OFAC - Homeowners Additional Interests
  ...
  Scenario: CA_001 OFAC - Homeowners California Specific Scenario

    Given I use "CA_001" regression test data from "QuoteCreatorHO" sheet
    When I am logged in to Pure as "P70" unless is PROD then "A1"
    Then I set "First_Name" to "Marko"
    Then I set "Last_Name" to "Milosevic"
    And I navigate to quotes page
    Then I initiate a new quote
    * I create a new "HO" quote
    * I rate a quote
    ...
    * I set the LLC trust questionnaire legal entity name to "MANCO OIL COMPANY"
    * I set the LLC trust questionnaire block legal entity type to "Other"
    * I set the LLC trust questionnaire block other legal entity type to "Nonprofit"
    * I set the LLC trust questionnaire tax ID or FEIN to "12-3123123"
    * I set the LLC trust questionnaire address line 1 to "1815 E West Pkwy"
    ...
    * I set the please provide the principal beneficial owners name or employees 0 first name to "Peter"
    * I set the please provide the principal beneficial owners name or employees 0 last name to "John"
    * I set the please provide the principal beneficial owners name or employees 0 DOB to "01/01/1991"
    * I set the please provide the principal beneficial owners name or employees 0 type to "Principal/Beneficial Owner"
    * I set the please provide the principal beneficial owners relationship to 0 named insured to "Named Insured"
    ...
    * I rate an endorsement
    When I navigate to underwriting referrals page
    Then I verify if there are 1 OFAC referrals
    And I accept underwriting referrals
    Then I issue an endorsement
    * I set "Endorsement_Effective_Date_END" to "08/08/2024"
    ...
    * I set the named insured type to "Limited Liability Company (LLC)"
    * I set name of resident to "SITTI GENERAL TRADING LLC"
    * I click Create new Entity
    * I think for 3 to 5 seconds
    * I navigate via action button next
    * I think for 3 to 5 seconds
    * I set the LLC trust questionnaire legal entity name to "SITTI GENERAL TRADING LLC"
    * I set the LLC trust questionnaire block legal entity type to "LLC"
    * I set the LLC trust questionnaire tax ID or FEIN to "12-3123123"
    * I set the LLC trust questionnaire address line 1 to "1815 E West Pkwy"
    * I set the LLC trust questionnaire city to "Fleming Island"
    ...
    * I click save changes button
    ...
    And I accept underwriting referrals
    Then I issue an endorsement
    * I set "Endorsement_Effective_Date_END" to "09/09/2024"
    ...
    * I click more changes button
    ...
    When I navigate to Homeowner Policy Page
    * I set the named insured type to "Trust"
    * I set name of resident to "RED SEA TRANSIT & TRANSPORT SERVICE"
    * I click Create new Entity
    * I think for 3 to 5 seconds
    * I navigate via action button next
    * I think for 3 to 5 seconds
    * I set the LLC trust questionnaire legal entity name to "RED SEA TRANSIT & TRANSPORT SERVICE"
    * I set the LLC trust questionnaire block legal entity type to "Trust"
    * I set the LLC trust questionnaire tax ID or FEIN to "12-3123123"
    * I set the LLC trust questionnaire address line 1 to "1815 E West Pkwy"
    * I set the LLC trust questionnaire city to "Fleming Island"
    * I set the LLC trust questionnaire state to "FL"
