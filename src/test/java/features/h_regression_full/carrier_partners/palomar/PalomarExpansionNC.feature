...
Feature: Palomar Excess and Surplus Company NC
  ...
  Scenario: TC_1: HS NC -  Removal of hard stop for Palomar Excess and Surplus Company NB
  ...
  @US46671
  Scenario: TC_2: HS NC - Before PD: Verifying carrier details for NB and Renewal RN transactions with manual renewal, TIV under $10M - PSE expected
  ...
  @US46671
  Scenario: TC_3: HS NC - Before PD: Verifying carrier details for NB and Renewal RN transactions with auto renewal, TIV under $10M
  ...
  @US46671
  Scenario: TC_4: HS NC - Verify that for TIV < $10M, the default carrier is Palomar, and for TIV ≥ $10M on Renewals, it defaults to "Select" and is overridden to "PURE Specialty Exchange.
  ...
  @US46671
  Scenario: TC_5: HS NC - After PD - Verify that for TIV < $10M, the default carrier is Palomar, and for TIV ≥ $10M on Renewals, it defaults to "Select" and is overridden to "Palomar".
  ...
  @FullRegression_DreamTeam @PalomarExpansion @HS @US46671
  Scenario: TC_6: HS NC - After PD filing date with TIV < $10M, verify the carrier partner defaults to 'Select' due to Inflation on RN transactions.
  ...
  @FullRegression_DreamTeam @ReRun @PalomarExpansion @HS @US46671
  Scenario: TC_7: HS NC - After PD Filing, verify that changes from EN are reflected in RN.
...
#    * I set "Endorsement_Effective_Date_END" to "02/02/2025"
  ...
  @US46671
  Scenario: TC_8: HS NC - After PD filing date with TIV > $10M, update TIV to < $10M during EN and verify it defaults to PSE.
...
#    add hurricane and named storm
  ...
  @US46671
  Scenario: TC_9: HS NC - After PD with TIV > $10M, override to PSE, verify validations do not trigger on RN, OOS EN, and RN roll forward.
  ...
  @US46671
  Scenario: TC_10: HS NC - After PD with TIV > $10M, override to Palomar, verify validations trigger on RN, OOS EN, and RN roll forward.
  ...
  @US46671
  Scenario: TC_11: HS NC - Before PD filing date TIV < 10M, cancel the policy and make NB rwt effective 01/18 TIV < 10M - verify its Palomar
...
#     #Cancellation
  ...
  @Palomar @HS @US46669
  Scenario: TC_12: HS NC - After PD filing date TIV < 10M, verify when condo is selected, carrier is defaulting to PSE

    Given I use "NC_001" regression test data from "QuoteCreatorHS" sheet

    * I load random user data
    * I set "Risk_Addresses_Replacement_Cost" to "5000000"
    * I set "Risk_Addresses_Hurricane_Deductible" to "N/A - AOP Ded. Applies"
    * I set "Usage_Under_Construction_Or_Major_Renovation" to "No"
    * I set "Effective_Date" to "02/01/2025"
  ...
  @HS @US46669
  Scenario: TC_13: HS NC - After PD filing date TIV < 10M - NB, verify carrier defaults to Palomar
  ...
  @US46669
  Scenario: TC_14: HS NC - After PD filing date with TIV > $10M, verify it defaults to PSE.
  ...
  @US46669
  Scenario: TC_15: HS NC - After PD filing Validate if optional coverages for Primary Home default on Palomar
  ...
  @US46669
  Scenario: TC_16: HS NC - After PD filing Validate if optional coverages for Seasonal Home / Secondary default on Palomar
  ...
  @US46669
  Scenario: TC_17: HS NC - After PD filing Validate if optional coverages for Rented To Others default on Palomar
  ...
  @US46669
  Scenario: TC_18: HS NC - After PD filing Validate if optional coverages for Vacant Residence default on Palomar
  ...
  @FullRegression_DreamTeam @PalomarExpansion @HS @US48118 @ReRun2
  Scenario: TC_19: HS NC - After PD filing date TIV > 10M - NB, override to Palomar verify that validations are triggered
  ...
  @FullRegression_DreamTeam @PalomarExpansion @HS @US46671 @ReRun
  Scenario: TC_20: HS NC - After PD filing date with TIV < $10M, verify the carrier partner defaults to Palomar on NB and RN
