@HomeownersSurplus @US45902 @TF107 @TF1154 @TF1166
...
Feature: PSE
  ...
  @TC90237  @TC90239 @TC90238 @TC90240
  Scenario Outline: Verify that the new functionality is applicable on NB
  ...
  Verify new functionality according to the PD Filling dates
    ...
    * I verify "Contents" is displayed
    ...
    Examples:
      ...
      | NY_002 | PURE Specialty Exchange                |
      | NY_001 | Accredited Specialty Insurance Company |
      | NY_002 | Accredited Specialty Insurance Company |

  @TC90239 @TC90238
  Scenario Outline: Verify that the new functionality is applicable on Endorsement
  Verify that the new section with fields is visible when "Yes" is selected for the field "Do you wish to include excess flood coverage?
  Verify that the new functionality is applicable for Accredited and PSE
  Verify new functionality according to the PD Filling dates
  ...
  @TC90239 @TC90238
  Scenario Outline: Verify that the new functionality is applicable on Renewal
  Verify that the new section with fields is visible when "Yes" is selected for the field "Do you wish to include excess flood coverage?
  Verify that the new functionality is applicable for Accredited and PSE
  Verify new functionality according to the PD Filling dates
  ...
  @TC90243  @TC90242
  Scenario Outline:NY User quotes Homeowner residence type and enters values of 10 million for Excess Flood Dwelling and 5 million for Excess Flood Contents.
