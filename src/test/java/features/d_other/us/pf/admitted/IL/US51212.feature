@PrimaryFlood @Admitted @US51212
Feature: PF Admitted - Flood Node - Primary Flood Coverage Block - UI - IL
  ...
  @TC98874
  Scenario: US51212 - Verify Primary Flood Coverage block for multiple locations NB and END - IL_004 - 09/07/2025
...
#    * I verify checkbox is "visible" for label "UW Manager Override" in "primary flood coverage" block - commented out since it depends on location eligibility
  ...
  @TC98896
  Scenario: US51212 - Verify Primary Flood Coverage block for multiple locations NB and RNW - IL_001 - 09/07/2025
...
#    * I verify checkbox is "visible" for label "UW Manager Override" in "primary flood coverage" block - commented out since it depends on location eligibility
  ...
  @TC98897
  Scenario: US51212 - Verify Primary Flood Coverage block for multiple locations NB and RNW - IL_001 - 09/07/2024
