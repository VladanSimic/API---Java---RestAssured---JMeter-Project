@PrimaryFlood @Admitted @US60803 @RUNRUN
Feature: PF Admitted - Turning on RI - QA Test Only 10/19/2025

#  #Tests copied from NJ

  @TC117651 @HO
  Scenario: TC117651 - Verify flood history questions are mandatory when PURE Primary Flood Endorsement is Yes and optional when No (NB / END) - 10/19/2025

    Given I use "RI_001" smoke test data from "QuoteCreatorHO" sheet
    ...
    * I set "Address_Line_1_Txt" to "90 Brenton Road"
    ...
    * I click "No" radio button for label "Has the property experienced any sump pump failure or backup of sewer drains in the last ten years?"
    ...
    When I navigate to Homeowner Policy Page and add new risk location with basic details except Flood Page
      ...
      | 814 Lake Rd  | Tiverton | RI    | 02878 | Condo/Co-op   | 7500000 |           | 10,000 | Not Available | 1 |

    Then I navigate to "Tiverton RI" page
  ...
  @TC117652 @HO
  Scenario: TC117652 - Verify additional questions become mandatory when 'Quote a Non-Admitted Flood Primary' is 'Yes', and the floor count field accepts only values within the valid range (NB/END) - 10/19/2025
    ...
    * I fill out HO Flood Coverage page
    ...
    When I navigate to Homeowner Policy Page and add new risk location with basic details only
      ...
      | 89 Reservoir Rd | Coventry | RI    | 02816 | Homeowner     | 7500000 |           | 10,000 | Not Available |

    Then I navigate to "Coventry RI" page
    * I click order property details button
    * I navigate to "Flood Coverage" page
  ...
  @TC117650 @HO
  Scenario: TC117650 - Verify that Excess Flood Block is updated (Homeowners/Condo, NB/END) - 10/19/2025
    ...
    * I navigate to Homeowner Policy Page and add new risk location with basic details only
      | addressLine1    | city     | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible    |
      | 89 Reservoir Rd | Coventry | RI    | 02816 | Condo/Co-op   | 7500000 |           | 10,000 | Not Available |
    * I click order property details button

    * I navigate to "Coventry RI" page
    * I navigate to "Flood Coverage" page
    * I click "Yes" radio button for label "Do you wish to include excess flood coverage?"
...
#    * I verify input field "Excess Flood Dwelling Options" is read only with value "- Select -"
  ...
  @TC117637 @HO
  Scenario: TC117637 - Verify Flood information block for multiple locations (NB/RNW) - 10/19/2024
    ...
    * I navigate to Homeowner Policy Page and add new risk location with basic details only
      | addressLine1    | city     | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible    |
      | 89 Reservoir Rd | Coventry | RI    | 02816 | Tenants       | 7500000 |           | 10,000 | Not Available |
    * I navigate to "Coventry RI" page
    * I click order property details button
    ...
    * I take screenshot "Flood information block - RNW"
    ...
    When I navigate to "Newport RI" page
  ...
  @TC117644 @HO
  Scenario: TC117644 - Verify Primary Flood Coverage block for multiple locations (NB/END) - 10/19/2025
...
#    * I verify checkbox is "visible" for label "UW Manager Override" in "primary flood coverage" block - commented out since it depends on location eligibility
    ...
    * I fill out HO Flood Coverage page
    ...
    When I navigate to Homeowner Policy Page and add new risk location with basic details
      ...
      | 814 Lake Rd  | Tiverton | RI    | 02878 | Condo/Co-op   | 7500000 |           | 10,000 | Not Available | 1 |
    * I click order property details button
    * I navigate to "Tiverton RI" page
    * I navigate to "Flood Coverage" page
    * I click "Manager Flood Zone Override" checkbox in "flood information" block
    * I set the flood zone to "AE/A1-A30/A Unnumbered"
    * I fill out HO Flood Coverage page
...
#    * I verify checkbox is "visible" for label "UW Manager Override" in "primary flood coverage" block - commented out since it depends on location eligibility
    ...
    * I navigate to Homeowner Policy Page and add new risk location with basic details only
      | addressLine1    | city      | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible    |
      | 123 Main Street | Pawtucket | RI    | 02860 | Tenants       | 7500000 |           | 10,000 | Not Available |
    * I click order property details button
    * I navigate to "Newport RI" page
    * I navigate to "Flood Coverage" page
    * I scroll to the bottom of the page
    ...
    When I navigate to "Coventry RI" page
    * I navigate to "Flood Coverage" page
    * I scroll to the bottom of the page

    Then I take screenshot "Second location - END"

    When I navigate to "Pawtucket RI" page
    * I navigate to "Flood Coverage" page
    * I click "Manager Flood Zone Override" checkbox in "flood information" block
    * I set the flood zone to "AE/A1-A30/A Unnumbered"
    * I fill out HO Flood Coverage page
...
#    * I verify checkbox is "visible" for label "UW Manager Override" in "primary flood coverage" block - commented out since it depends on location eligibility
  ...
  @TC117649 @HO
  Scenario Outline: TC117649 - "<user>" - Verify that Manager Primary Flood Override is displayed on the UI when PURE Flood endorsement is ineligible for all internal users
  ...
  @TC117648 @HO
  Scenario: TC117648 - Verify that new questions are not mandatory to rate for the existing locations on Renewal after REN PD Filing date (NB/RNW) - 10/19/2024
    ...
    * I click "No" radio button for label "Do you purchase an NFIP policy with maximum limits?"
    ...
    Then I navigate to Homeowner Policy Page and add new risk location with basic details except Flood Page
      | addressLine1 | city     | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible    | i |
      | 814 Lake Rd  | Tiverton | RI    | 02878 | Tenants       | 7500000 |           | 10,000 | Not Available | 1 |
    * I navigate to "Tiverton RI" page
    * I click order property details button
    * I navigate to "Flood Coverage" page
  ...
  @TC117645 @HO
  Scenario: TC117645 - Verify Primary Flood Coverage block for multiple locations (NB/RNW) - 10/19/2025
...
#    * I verify checkbox is "visible" for label "UW Manager Override" in "primary flood coverage" block - commented out since it depends on location eligibility
  ...
  @TC117636 @HO
  Scenario: TC117636 - Verify new blocks are available for different transactions and additional locations (NB/END) - 10/19/2025
  ...
  @TC117636 @HO
  Scenario: TC117636 - Verify new blocks are available for different transactions and additional locations (NB/RNW) - 10/19/2025
  ...
  @TC117640 @HO
  Scenario: TC117640 - Verify fields visibility in flood information block for multiple locations NB and RNW - 10/19/2024
  ...
  @TC117647 @HO
  Scenario: TC117647 - Verify that the new Quoting Section is placed just below "Elevated Risk Credit (internal only" and "High PML Load (internal only)" fields of the "primary flood coverage" block (NB/END) - 10/19/2025
  ...
  @TC117642 @HO
  Scenario: TC117642 - Verify that "elevation certificate" block is added to the newly created Flood node below 'storm surge' block for HO IL state (NB/END scenario)
    Given I use "RI_001" smoke test data from "QuoteCreatorHO" sheet
    * I turn off optional data
    ...
    * I fill out HO Flood Coverage page
    ...
    When I navigate to Homeowner Policy Page and add new risk location with basic details
      | addressLine1    | city     | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible    | i |
      | 89 Reservoir Rd | Coventry | RI    | 02816 | Condo/Co-op   | 7500000 |           | 10,000 | Not Available | 1 |
    * I navigate to "Coventry RI" page
    * I navigate to "Flood Coverage" page
    * I set the check manager flood zone override to "Yes"
    * I set the flood zone to "AE/A1-A30/A Unnumbered"
    ...
    * I navigate to Homeowner Policy Page and add new risk location with basic details
      | addressLine1    | city      | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible    | i |
      | 123 Main Street | Pawtucket | RI    | 02860 | Tenants       | 7500000 |           | 10,000 | Not Available | 1 |
    * I navigate to "Flood Coverage" page
    * I set the check manager flood zone override to "Yes"
    * I set the flood zone to "AE/A1-A30/A Unnumbered"
  ...
  @TC117641 @HO
  Scenario: TC117641 - Verify that Elevation Certificate node is removed from the UI - multiple locations (NB/END) - 10/19/2025
    ...
    * I navigate to Homeowner Policy Page and add new risk location with basic details only
      ...
      | 123 Main Street | Pawtucket | RI    | 02860 | Tenants       | 7500000 |           | 10,000 | Not Available |
    * I click order property details button
    * I navigate to "Pawtucket RI" page
    * I navigate to "Flood Coverage" page
    * I click "Manager Flood Zone Override" checkbox in "flood information" block
    * I set the flood zone to "AE/A1-A30/A Unnumbered"
    * I click save changes button
  ...
  @TC117646 @HO
  Scenario: TC117646 - Verify the questions for the "1,2,3,4" diagram number and empty "d) Bottom of the attached garage (top of slab)?" (NB/END) - 10/19/2025
...
#  Tests added 09/29 by Milan and Diana
  ...
  @TC118296 @HO #TC99545
  Scenario: TC118296 - Verify Flood information and Excess blocks for multiple locations NB and END - RI_001  - 10/18/2025
  ...
  @TC118305 @HO #TC101890
  Scenario: TC118305 - Verify that new questions are added to the section "What is the Elevation of the" for Building Diagram - 1,2,3,4 (NB/END) - RI_001 - 10/19/2025
  ...
  @TC118336 @HO #TC105284
  Scenario: TC118336 - Verify that new questions are optional to rate and mandatory to bind for new business policies and mandatory to rate for newly added risk locations on the existing policies (NB/END) - RI - 10/19/2025
    ...
    * I type "10,000" to "h) Lowest adjacent grade at lowest elevation of deck or stairs, including structural support?" input field
    ...
    Then I navigate to Homeowner Policy Page and add new risk location with basic details only
      | addressLine1 | city     | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible |
      | 814 Lake Rd  | Tiverton | RI    | 02878 | Condo/Co-op   | 7500000 |           | 10,000 |            |
    * I click order property details button

    When I navigate to "Tiverton RI" page
    * I navigate to "Flood Coverage" page
    * I click "Manager Flood Zone Override" checkbox in "flood information" block
    * I set the flood zone to "AE/A1-A30/A Unnumbered"
  ...
  @TC118386 @HO #TC104565
  Scenario: TC118386 - Verify that the Quoting Section is not displayed on the UI if Residence Type is "Tenants" - RI (NB) - 10/19/2025
  ...
  @TC118390 @HO #TC105996
  Scenario: TC118390 - Verify Flood Coverage function for inforce renewals (NB/RNW) - RI_001 - 10/19/2025
  ...
  @TC118395 @HO #TC110136
  Scenario: TC118395 - 8. Verify that after HO RI post-PD RNW, the new questions are displayed and mandatory when 'Yes' is selected, and are not displayed when 'No' is selected - 10/19/2024
    ...
    * I choose "Yes" for "Do you have a basement, or any area of the unit, including a sunken room or sunken portion of a room, below ground level (subgrade) on all sides, OR, do you have any personal contents stored in a subgrade area in the building?"
    ...
    When I navigate to Homeowner Policy Page and add new risk location with basic details only
      | addressLine1 | city     | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible |
      | 814 Lake Rd  | Tiverton | RI    | 02878 | Homeowner     | 7500000 |           | 10,000 | 2%         |
  ...
  @TC118398 @HO #TC97705
  Scenario: TC118398 - Verify Optional flood coverage block for NB, END and RNW - RI_001 - 10/18/2024

    Given I use "RI_001" smoke test data from "QuoteCreatorHO" sheet
    * I load random user data
    * I set "Effective_Date" to "10/18/2024"
    * I set "Endorsement_Effective_Date_END" to "10/19/2024"
    * I set all optional coverages to no
    * I set "Additional_Interests" to ""
    * I set "Manual_Subjectivities" to ""
  ...
  @TC118440 @HO #TC109549
  Scenario: TC118440 - 4. Verify that on HO RI post-PD RNW, UW questions are optional for existing locations, but mandatory for newly added ones - RI - 10/19/2024
    ...
    * I take screenshot "UW questions - not mandatory (NB location)"
    ...
    When I navigate to Homeowner Policy Page and add new risk location with basic details only
      | addressLine1    | city    | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible |
      | 90 Brenton Road | Newport | RI    | 02840 | Condo/Co-op   | 7500000 |           | 10,000 |            |

    Then I navigate to "Newport RI" page
    * I click order property details button
    * I navigate to "Flood Coverage" page
  ...
  @TC118649
  Scenario: TC118649 - Verify that when location is eligible question  "Do you want to add the PURE Primary Flood Endorsement?" is mandatory and internal message is displayed “This home is eligible for admitted primary flood coverage.” (NB/END) - RI - 10/19/2025
    ...
    * I click "No" radio button for label "Refer Rate:"
    ...
    When I navigate to Homeowner Policy Page and add new risk location with basic details except Flood Page
      | addressLine1 | city     | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible | i |
      | 814 Lake Rd  | Tiverton | RI    | 02878 | Condo/Co-op   | 7500000 |           | 10,000 |            | 1 |
    * I click order property details button
    * I navigate to "Tiverton RI" page
    * I navigate to "Flood Coverage" page
  ...
  @TC117651
  Scenario: TC117651 - Verify HO RI flood history questions are mandatory when PURE Primary Flood Endorsement is Yes and optional when No (NB / END) - 10/19/2025
  ...
  @TC118647
  Scenario: TC118647 - Verify that the Flood information block is removed from the Location coverage page after PD Filling dates (NB/END) - 10/19/2025
    ...
    * I navigate to Homeowner Policy Page and add new risk location with basic details only
      | addressLine1 | city     | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible    |
      | 814 Lake Rd  | Tiverton | RI    | 02878 | Condo/Co-op   | 7500000 |           | 10,000 | Not Available |
    * I navigate to "Tiverton RI" page
