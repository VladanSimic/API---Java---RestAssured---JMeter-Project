...
Feature: Change Request: PF Admitted - Update FS Quoting section on Primary Flood Coverage block - IL & CO
  ...
  @TC110127
  Scenario: US57017 - 1. Verify HO IL additional questions become mandatory when 'Quote a Non-Admitted Flood Primary' is 'Yes', and the floor count field accepts only values within the valid range (NB/END) - 09/07/2025
  ...
  @TC110128
  Scenario: US57017 - 2. Verify HO IL additional questions are not displayed when 'Quote a Non-Admitted Flood Primary' is 'No' (NB/RNW) - 09/07/2025
  ...
  @TC110129
  Scenario: US57017 - 3. Verify that after HO IL post-PD endorsement, new questions appear and are mandatory when 'Yes', hidden when 'No', and that the floor count field accepts only valid values - 09/06/2025
  ...
  @TC110130
  Scenario: US57017 - 4. Verify that after HO IL post-PD RNW, the new questions are displayed and mandatory when 'Yes' is selected, and are not displayed when 'No' is selected - 09/07/2024
