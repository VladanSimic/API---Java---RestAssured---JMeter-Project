@PrimaryFlood @Admitted @US51755
Feature: PF Admitted - Add Elevation Certificate Details to Flood Node -UI & Function - IL
  ...
  @TC100386
  Scenario: US51755 - Verify that "elevation certificate" block is added to the newly created Flood node below 'storm surge' block for HO IL state (NB/REN scenario)
    Given I use "IL_001" smoke test data from "QuoteCreatorHO" sheet
    * I turn off optional data
    * I set "First_Name" to "Automation"
    * I set "Last_Name" to "DontTouch"
    ...
    * I navigate to Homeowner Policy Page and add new risk location with basic details
      | addressLine1      | city    | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible | i |
      | 1457 W Erie St #3 | Chicago | IL    | 60642 | Homeowner     | 7500000 |           | 10,000 | 5%         | 2 |
    * I navigate to "Chicago IL" 2 page
    * I navigate to "Flood Coverage" page
    * I set the check manager flood zone override to "Yes"
    * I set the flood zone to "AE/A1-A30/A Unnumbered"
  ...
  @TC100387
  Scenario: US51755 - Verify that "elevation certificate" block is added to the newly created Flood node below 'storm surge' block for HO IL state on Renewal transaction
    Given I use "IL_001" smoke test data from "QuoteCreatorHO" sheet
    * I turn off optional data
    * I set "First_Name" to "Automation"
    * I set "Last_Name" to "DontTouch"
    ...
    * I take screenshot "elevation certificate - RNW"
    ...
    When I navigate to "Chicago IL" 1 page
    * I navigate to "Flood Coverage" page
...
#  @TC100388
#  Scenario: Verify that "elevation certificate" block is added to the newly created Flood node below 'storm surge' block for HO IL state on Midterm Endorsement for newly added locations
#    Given I use "IL_001" smoke test data from "QuoteCreatorHO" sheet
#    * I turn off optional data
#    * I set "First_Name" to "Automation"
#    * I set "Last_Name" to "DontTouch"
...
#    * I navigate to Homeowner Policy Page and add new risk location with basic details
#      | addressLine1   | city    | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible | i |
#      | 938 N Noble St | Chicago | IL    | 60642 | Homeowner     | 7500000 |           | 10,000 | 5%         | 2 |
#    * I navigate to "Chicago IL" 2 page
#    * I navigate to "Flood Coverage" page
#    * I set the check manager flood zone override to "Yes"
#    * I set the flood zone to "AE/A1-A30/A Unnumbered"
...
#    * I verify input field "Panel Date" in "flood information" block is read only and has value
#
#    * I set "Base_Flood_Elevation" to "123"
#    * I set "Building_Diagram_Number" to "1,2,3,4"
#    * I set "Top_Of_Bottom_Floor" to "1"
#    * I set "Top_Of_Next_Floor" to "1"
#    * I set "Bottom_Of_The_Attached_Garage" to "1"
...
#    * I verify input field "Panel Date" in "flood information" block is read only and has value
  ...
  @TC100390
  Scenario: US51755 - Verify that "elevation certificate" block is not added to the newly created Flood node below 'storm surge' block for HO IL state before NB PD Filing date
    Given I use "IL_001" smoke test data from "QuoteCreatorHO" sheet
    * I turn off optional data
    * I set "First_Name" to "Automation"
    * I set "Last_Name" to "DontTouch"
  ...
  @TC100391
  Scenario: US51755 - Verify that "elevation certificate" block is not added to the newly created Flood node below 'storm surge' block for HO IL state before REN PD Filing date
    Given I use "IL_001" smoke test data from "QuoteCreatorHO" sheet
    * I turn off optional data
    * I set "First_Name" to "Automation"
    * I set "Last_Name" to "DontTouch"
    ...
    * I navigate to "Chicago IL" 1 page
    ...
    When I navigate to "Chicago IL" 2 page
    * I set the check manager flood zone override to "Yes"
    * I set the flood zone to "AE/A1-A30/A Unnumbered"
...
#  @TC100392 N/A – 3 new questions were added to the UI later
#  Scenario: Verify that the functionality of the "elevation certificate" block is the same after NB PD Filing date for HO IL state.
#    Given I use "IL_001" smoke test data from "QuoteCreatorHO" sheet
#    * I turn off optional data
#    * I set "First_Name" to "Automation"
#    * I set "Last_Name" to "DontTouch"
