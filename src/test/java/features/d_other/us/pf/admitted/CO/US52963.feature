@PrimaryFlood @Admitted @US52963
Feature: PF - Admitted - UI - Flood Node - Add Primary Flood Block - Condo & Tenants only - CO
  ...
  #Last cosmetic changes done through US53558, function updated through other USs. TCs updated accordingly

  @TC101467
  Scenario: US52963 - Verify Primary Flood Coverage block for multiple locations NB and END - CO_005 - 09/07/2025
...
#    * I set the page zoom to 75 percent
    ...
    * I verify the "Do you purchase an NFIP policy with maximum limits?" label with "Yes" and "No" radio buttons is "visible" in "primary flood coverage" block
    * I verify the "Does the location have a PURE NFIP Flood Policy?" label with "Yes" and "No" radio buttons is "visible" in "primary flood coverage" block
...
#    * I verify checkbox is "visible" for label "UW Manager Override" in "primary flood coverage" block - commented out since it depends on location eligibility
  ...
  @TC101468
  Scenario: US52963 - Verify Primary Flood Coverage block for multiple locations NB and RNW - CO_003 - 09/07/2025
...
#    * I verify checkbox is "visible" for label "UW Manager Override" in "primary flood coverage" block - commented out since it depends on location eligibility
  ...
  @TC101469
  Scenario: US52963 - Verify Primary Flood Coverage block for multiple locations NB and RNW - CO_002 - 09/07/2024
