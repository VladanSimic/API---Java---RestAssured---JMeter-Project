@PrimaryFlood @Admitted @US54562
Feature: PF - Admitted - Primary Flood Coverage Block - Function - CO
  ...
  @TC105990
  Scenario: US54562 - Verify that when location is eligible question  "Do you want to add the PURE Primary Flood Endorsement?" is mandatory and internal message is displayed “This home is eligible for admitted primary flood coverage.” (NB/END) - CO_001 - 09/07/2025
    ...
    * I take screenshot "Basement limits - default values"
    ...
    When I click "No" radio button for label "Does the location have a PURE NFIP Flood Policy?"
  ...
  @TC105991
  Scenario: US54562 - Verify that when location is eligible question  "Do you want to add the PURE Primary Flood Endorsement?" is mandatory and internal message is displayed “This home is eligible for admitted primary flood coverage,” and sunken question is No (NB/RNW) - CO_001 - 09/07/2025
    Given I use "CO_001" smoke test data from "QuoteCreatorHO" sheet
    * I load random user data
    * I set "Effective_Date" to "09/07/2025"
    * I set all optional coverages to no
    ...
    * I click "No" radio button for label "Refer Rate:"
    ...
    When I navigate to Homeowner Policy Page and add new risk location with basic details except Flood Page
      | addressLine1        | city   | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible | i |
      | 701 Galapago Street | Denver | CO    | 80204 | Homeowner     | 7500000 |           | 10,000 | 2%         | 1 |
    * I click order property details button
    * I navigate to "Denver CO" page
  ...
  @TC105992
  Scenario: US54562 - Verify that when location is eligible question  "Do you want to add the PURE Primary Flood Endorsement?" is mandatory and internal message is displayed “This home is eligible for admitted primary flood coverage.” Tenants (NB/RNW) - CO_003 - 09/07/2025
    ...
    * I click "No" radio button for label "Refer Rate:"
    ...
    When I navigate to Homeowner Policy Page and add new risk location with basic details except Flood Page
      | addressLine1          | city   | state | zip   | residenceType | covAorC | lossOfUse | aopDed | deductible | i |
      | 1437 Columbine Street | Denver | CO    | 80206 | Tenants       | 7500000 |           | 10,000 | 2%         | 1 |
    * I click order property details button
    * I navigate to "Denver CO" page
    * I navigate to "Flood Coverage" page
  ...
  @TC105996
  Scenario: US54562 - Verify Flood Coverage function for inforce renewals (NB/RNW) - CO_001 - 09/07/2024
    ...
    * I create a new "HO" quote for a new customer
    ...
    When I navigate to "Platteville CO" page
    * I click order property details button
    * I navigate to "Flood Coverage" page
