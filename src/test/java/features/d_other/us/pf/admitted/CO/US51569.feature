@PrimaryFlood @Admitted @US51569
Feature: PF Admitted - Flood Node - Primary Flood Coverage Block - UI - CO
  ...
  @TC99209
  Scenario: US51569 - Verify Primary Flood Coverage block for multiple locations NB and END - CO_004 - 09/07/2025
...
#    * I verify checkbox is "visible" for label "UW Manager Override" in "primary flood coverage" block - commented out since it depends on location eligibility
  ...
  @TC99210
  Scenario: US51569 - Verify Primary Flood Coverage block for multiple locations NB and RNW - CO_001 - 09/07/2025
...
#    * I verify checkbox is "visible" for label "UW Manager Override" in "primary flood coverage" block - commented out since it depends on location eligibility
  ...
  @TC99211
  Scenario: US51569 - Verify Primary Flood Coverage block for multiple locations NB and RNW - CO_001 - 09/07/2024
