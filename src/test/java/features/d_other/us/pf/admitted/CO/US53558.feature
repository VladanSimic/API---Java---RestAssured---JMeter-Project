...
Feature: PF - Admitted - Primary Flood Coverage Block - Cosmetic Updates - Home & Condo/Tenants - IL &  CO
  ...
  @TC104422
  Scenario: US53558 - Verify that labels mentioned in the US are updated for the residence type Homeowners, Condos and Tenants (CO state, NB/END) - 09/07/2025
...
#    Then I verify checkbox is "visible" for label "Manager Primary Flood Override" in "primary flood coverage" block - commented out since it depends on location eligibility
  ...
  @TC104423
  Scenario: US53558 - Verify that labels mentioned in the US are updated for the residence type Homeowners, Condos and Tenants (CO state, NB/RNW) - 09/07/2025
