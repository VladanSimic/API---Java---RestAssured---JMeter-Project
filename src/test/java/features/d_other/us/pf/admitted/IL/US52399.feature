@PrimaryFlood @Admitted @US52399
Feature: PF Admitted - Add Non-Admitted FS Quoting Section to Primary Flood Coverage Block - UI - IL Home & Condo
  As a product manager, I want to add the ability to quote non-admitted Flood Solutions to the Primary Flood Coverage block

  @TC104601
  Scenario: US52399 - Verify that the new Quoting Section is placed just below "Elevated Risk Credit (internal only" and "High PML Load (internal only)" fields of the "primary flood coverage" block - IL (NB/END) - 09/07/2025
  ...
  @TC104602
  Scenario: US52399 - Verify limits in the new Quoting Section IL NB Homeowners, RNW Condo - IL (NB/RNW) - 09/07/2025
  ...
  @TC104603
  Scenario: US52399 - Verify that the Quoting Section is not displayed on the UI if Residence Type is "Tenants" - IL (NB) - 09/07/2025
