@PrimaryFlood @PFHS @US55636
Feature: Change Request: HS - Update Elevation Certificate Questions - NC - UI
  As a product manager, I want "elevation certificate" page to be updated on the HS LOB

  @TC107623
  Scenario: US55636 - Verify that new questions are added to the section "What is the Elevation of the" for Building Diagram - 1,2,3,4 (NB/END) - 09/07/2025
  ...
  @TC107624
  Scenario: US55636 - Verify that new questions are added to the section "What is the Elevation of the" for Building Diagram - 6/7/8 and 1,2,3,4 (w/vented garage) - NB/RNW - 09/07/2025
  ...
  @TC107625
  Scenario: US55636 - Verify that new questions are added to the section "What is the Elevation of the" for Building Diagram 1,2,3,4 (w/vented garage) and 5 (NB/END) - 09/07/2025
  ...
  @TC107621
  Scenario: US55636 - Verify the questions for the "What is the Elevation of the" - 6/7/8 and 1,2,3,4 (w/ vented garage) diagram number NB/RNW - 09/07/2025
  ...
  @TC107622
  Scenario: US55636 - Verify the questions for the "What is the Elevation of the" - 5 and 1,2,3,4 diagram number (NB/RNW) - 09/07/2024
  ...
  @TC107626
  Scenario: US55636 - Verify the questions for the "What is the Elevation of the" - 1,2,3,4 diagram number (NB/END) - 09/06/2025
