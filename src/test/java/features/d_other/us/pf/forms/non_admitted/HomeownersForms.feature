@PrimaryFlood @NonAdmitted @FSFormsQASpecialHomeowner
Feature: FS - NonAdmitted -  Forms

  @FSNbEndCancReinstHomeSTGOptional
  Scenario Outline:  "<state>"
    ...
    * I set "Effective_Date" to "08/14/2025"
    ...
    * I set "Optional_Coverages_Earthquake_HO3254" to ""
    * I set "AOP_Ded" to "10,000"
    * I set "Deductible" to "10,000"
...
#      | VA_001 | not in scope for phase 1
  ...
  Scenario Outline: "<state>"
    ...
    * I set "Additional_Interests" to ""
    * I set "Manual_Subjectivities" to ""
    * I set "Address_Line_1_Txt" to "66 Twin Lakes Dr"
    * I set "City_Name_Txt" to "Halifax"
    * I set "Zip_Code" to "02338"
    * I set "Would_You_Like_To_Quote_Non_Admitted_PF" to "Yes"
    * I set "Primary_Flood_Policy" to "Yes"
    * I set "Current_Primary_Flood_Insurance_Carrier" to "PURE"
    * I set "Existing_Agency_Client" to "No"
