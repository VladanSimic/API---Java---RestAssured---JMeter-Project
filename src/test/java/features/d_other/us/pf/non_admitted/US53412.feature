@PrimaryFlood @NonAdmitted @US53412
Feature: FS - NonAdmitted - UI - Clone Documents Page
  As a Product Manager I want to clone Documents page
  to the new non-admitted flood surplus LOB.

  @TC102623 @TC102624 @TC102625
  Scenario Outline: US53412 - Verify that Documents page is available with all its buttons and block - "<state>" - 01/01/2025
    ...
    * I verify block "document list" is "visible" on page
    * I verify button "upload" is "visible" on page
    * I verify button "exit" is "visible" on page
    * I take screenshot "Documents page - FS"
