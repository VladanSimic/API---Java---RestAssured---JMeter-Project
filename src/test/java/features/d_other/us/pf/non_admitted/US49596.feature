@PrimaryFlood @NonAdmitted @US49596
Feature: FS - Manuscript Endorsement Tree
  As a Product Owner I would like to introduce a Manuscript Endorsements tree
  to the Primary Flood Product based on elements from the HS product

  @TC96491
  Scenario Outline: US49596 - Verify tree nodes pages for - "<state>" - 01/01/2025
  ...
  we are able to create quotes with the new nodes for Primary Flood
    ...
    * I expand location page tree
    ...
    Then I verify page "Manuscript Endorsements" is "visible" in tree
