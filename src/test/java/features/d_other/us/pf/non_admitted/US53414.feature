@PrimaryFlood @NonAdmitted @US53414
Feature: FS - NonAdmitted - UI - Clone Diary Page
  As a Product Manager I want to clone Diary page
  to the new non-admitted flood surplus LOB.

  @TC102632 @TC102633 @TC102634
  Scenario Outline: US53414 - Verify that Diary page is available with all its buttons and blocks - "<state>" - 01/01/2025
    ...
    * I verify block "carrier all tasks" is "visible" on page
    * I verify block "carrier overdue tasks" is "visible" on page
    * I verify button "new entry" is "visible" on page
    * I verify button "exit" is "visible" on page
    * I take screenshot "Diary page - FS"
