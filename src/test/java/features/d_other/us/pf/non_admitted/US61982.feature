@PrimaryFlood @US61982
Feature: FS - Turning on PA - QA Test Only 10/19/2025

  #FS Scenarios added 09/29 by Milan and Diana

  @TC118447 @FS #TC103593
  Scenario: TC118447 - Verify Construction Type field and its values - PA_001 - 10/19/2025

    Given I use "PA_001" smoke test data from "QuoteCreatorHOFS" sheet
  ...
  @TC118524 @FS #TC100393
  Scenario: TC118524 - Verify Cover page - Primary Flood Coverage block - PA_001 - 10/19/2025
  ...
  @TC118525 @FS #TC100455
  Scenario: TC118525 - Verify Cover page blocks and cells for - PA_001 - 10/19/2025
  ...
  @TC118526 @FS #TC100456
  Scenario: TC118526 - Verify Cover page UI and function - PA_001 - 10/19/2025
...
#    Then I verify "Is this Primary Flood policy being quoted concurrently with a PURE or PURE Programs new business policy or renewal offer?" is defaulted to "No"
  ...
  @TC118566 @FS #TC100196
  Scenario: TC118566 - Verify that flood information block is added to the Cover Page for - PA_001 - 10/19/2025
  ...
  @TC118643 @FS #TC106109
  Scenario: TC118643 - Verify question, labels and Current Primary Flood Insurance Carrier dropdown changes - PA_001 - 10/19/2025
