@PrimaryFlood @NonAdmitted @US49593
Feature: FS - Member Info Tree
  As a Product Owner I would like to introduce a Member Information tree
  to the Primary Flood Product similar to other lines of business

  @TC96534
  Scenario Outline: US49593 - Verify tree nodes pages for - "<state>" - 01/01/2025
  ...
  we are able to create quotes with the new nodes for Primary Flood
    ...
    * I expand location page tree
    ...
    Then I verify page "Member Information" is "visible" in tree
    * I take screenshot "Primary Flood - Member Information"

    When I navigate to "Member Information" page

    Then I verify block "member information" is "visible" on page
    * I verify block "appraisal information" is "not visible" on page
    * I take screenshot "Primary Flood - Member Information Blocks"
