@PrimaryFlood @NonAdmitted @US53410
Feature: FS - NonAdmitted - UI - Clone Underwriting Alerts Page UI & Function
  As a Product Manager I want to clone Underwriting Referrals page
  to the new non-admitted flood surplus LOB.

  @TC102801 @TC102802 @TC102803
  Scenario Outline: US53410 - Verify that Underwriting Referrals page is available with all its buttons and block - "<state>" - 01/01/2025
    ...
    * I navigate to underwriting referrals page
    ...
    Then I verify that "summary" tab is "visible" on page
    * I verify that "quote details" tab is "visible" on page
    ...
    * I verify block "referrals" is "visible" on page
    * I verify block "authority referrals" is "visible" on page
    * I verify block "comments" is "visible" on page
    * I verify button "save changes" is "visible" on page
    * I verify button "conditional" is "visible" on page
    * I verify button "end submission" is "visible" on page
    * I verify button "accept" is "visible" on page
    * I verify button "reassign/refer" is "visible" on page
    * I verify button "exit" is "visible" on page
    * I take screenshot "Underwriting Referrals page - FS"
