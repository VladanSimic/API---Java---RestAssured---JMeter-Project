@PrimaryFlood @US61981
Feature: FS - Turning on RI - QA Test Only 10/19/2025

  #FS Scenarios added 09/29 by Milan and Diana

  @TC118448 @FS #TC103593
  Scenario: TC118448 - Verify Construction Type field and its values - RI_001 - 10/19/2025

    Given I use "RI_001" smoke test data from "QuoteCreatorHOFS" sheet
  ...
  @TC118527 @FS #TC100393
  Scenario: TC118527 - Verify Cover page - Primary Flood Coverage block - RI_001 - 10/19/2025
  ...
  @TC118528 @FS #TC100455
  Scenario: TC118528 - Verify Cover page blocks and cells for - RI_001 - 10/19/2025
 ...
 #  * I verify the "Is this Primary Flood policy being quoted concurrently with a PURE or PURE Programs new business policy or renewal offer?" label with "Yes" and "No" radio buttons is "visible" in "policy information" block
  ...
  @TC118534 @FS #TC100456
  Scenario: TC118534 - Verify Cover page UI and function - RI_001 - 10/19/2025
...
#    Then I verify "Is this Primary Flood policy being quoted concurrently with a PURE or PURE Programs new business policy or renewal offer?" is defaulted to "No"
  ...
  @TC118567 @FS #TC100196
  Scenario: TC118567 - Verify that flood information block is added to the Cover Page for - RI_001 - 10/19/2025
  ...
  @TS118644 @FS #TC106110
  Scenario: TS118644 - Verify question, labels and Current Primary Flood Insurance Carrier dropdown changes - RI_001 - 10/19/2025
