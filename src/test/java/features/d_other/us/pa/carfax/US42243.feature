@PersonalAuto @US42243 @TF107 @TF880 @TF959
Feature: Carfax UI - Exotic Vehicles

  As an underwriter I would like to see Vehicle
  Characteristics for Exotic Vehicles so that better business
  insights to the vehicles we're adding into our books.

  @NewBusiness @S1 @TC84925 @TC84924 @TC84923 @TC84922 @TC84921
  Scenario Outline: Carfax UI US42243 - S1 - New Business - "<TC_ID>" - "<effectiveDate>" on PDF

    Given I have entered test data for test case "<TC_ID>" in excel workbook "us/US42243" in sheet "QuoteCreatorPA" for "PA" LOB
    ...
    * I click prev button
    ...
    Then I verify "Market Value" field is displayed
    * I verify vehicle characteristics block is displayed with
    ...
    @ExoticCollectors @CarfaxUI
    Examples:
      | TC_ID  | user | effectiveDate |
      | IN_001 | P126 | 10/01/2024    |
  ...
  @NewBusiness @S1a
  Scenario Outline: Carfax UI US42243 - S1a - New Business - "<TC_ID>" - "<effectiveDate>" on day before PDF
  ...
  @NewBusiness @Endorsement @S2 @TC84925 @TC84923 @TC84922 @TC84921
  Scenario Outline: Carfax UI US42243 - S2 - New Business - Endorsement - "<TC_ID>"
  ...
  @NewBusiness @Renewal @S3 @TC84925 @TC84924 @TC84923 @TC84922 @TC84921
  Scenario Outline: Carfax UI US42243 - S3 - New Business - Renewal - "<TC_ID>" - "<effectiveDate>" on PDF
  ...
  Scenario Outline: Carfax UI US42243 - S3a - New Business - Renewal - "<TC_ID>" - "<effectiveDate>" on day before PDF
  ...
  @NewBusiness @Endorsement @OOS @S4 @TC84925 @TC84923 @TC84922 @TC84921
  Scenario Outline: Carfax UI US42243 - S4 - New Business - Endorsement - OOS - "<TC_ID>"
  ...
  @NewBusiness @Renewal @OOS @S5 @TC84925 @TC84923 @TC84922 @TC84921
  Scenario Outline: Carfax UI US42243 - S5 - New Business - Renewal - OOS - "<TC_ID>"
  ...
  @NewBusiness @Endorsement @Renewal @OOS @S6 @TC84925 @TC84923 @TC84922 @TC84921
  Scenario Outline: Carfax UI US42243 - S6 - New Business - Endorsement - Renewal - OOS - "<TC_ID>"
  ...
  @NewBusiness  @S7 @TC84928 @TC84971
  Scenario Outline: Carfax UI US42243 - S7 - Negative - New Business - "<TC_ID>" - "<effectiveDate>" on PDF

    Given I have entered test data for test case "<TC_ID>" in excel workbook "us/US42244" in sheet "QuoteCreatorPA" for "PA" LOB
    * I set "Additional_Vehicles" to "<vehicle>"
    * I set "Effective_Date" to "<effectiveDate>"
    * I reload "us/US42243" vehicle data
    ...
    * I verify vehicle characteristics block is not displayed
    ...
    Examples:
      | TC_ID  | user | vehicle             |
      | AK_001 | P126 | AK_005_Vehicle_005, |
      | AR_001 | P127 | AK_006_Vehicle_006, |
      | AZ_001 | P128 | AK_007_Vehicle_007, |
      | CO_001 | P129 | AK_008_Vehicle_008, |
      | DC_001 | P130 | AK_009_Vehicle_009, |
      | IA_001 | P131 | AK_010_Vehicle_010, |
      | IL_001 | P132 | AK_011_Vehicle_011, |
      | IN_001 | P133 | AK_012_Vehicle_012, |
      | KS_001 | P134 | AK_005_Vehicle_005, |
      | KY_001 | P135 | AK_006_Vehicle_006, |
      | MN_001 | P136 | AK_007_Vehicle_007, |
      | MO_001 | P137 | AK_008_Vehicle_008, |
      | MT_001 | P138 | AK_008_Vehicle_008, |
      | ND_001 | P139 | ND_013_Vehicle_013, |
      | NE_001 | P140 | AK_011_Vehicle_011, |
      | NH_001 | P141 | AK_012_Vehicle_012, |
      | NM_001 | P142 | AK_005_Vehicle_005, |
      | NV_001 | P143 | AK_006_Vehicle_006, |
      | OH_001 | P144 | AK_007_Vehicle_007, |
      | OK_001 | P145 | AK_008_Vehicle_008, |
      | OR_001 | P146 | AK_008_Vehicle_008, |
      | PA_001 | P147 | AK_010_Vehicle_010, |
      | RI_001 | P148 | AK_011_Vehicle_011, |
      | SD_001 | P149 | AK_012_Vehicle_012, |
      | TN_001 | P150 | AK_005_Vehicle_005, |
      | UT_001 | P126 | AK_006_Vehicle_006, |
      | VT_001 | P127 | AK_006_Vehicle_006, |
      | WA_001 | P128 | AK_008_Vehicle_008, |
      | WI_001 | P129 | AK_008_Vehicle_008, |
      | WV_001 | P130 | AK_008_Vehicle_008, |
      | WY_001 | P131 | AK_011_Vehicle_011, |
      | AL_001 | P132 | AK_012_Vehicle_012, |
      | CA_001 | P133 | AK_005_Vehicle_005, |
      | CT_001 | P134 | AK_006_Vehicle_006, |
      | DE_001 | P135 | ND_013_Vehicle_013, |
      | HI_001 | P136 | AK_008_Vehicle_008, |
      | LA_001 | P137 | AK_008_Vehicle_008, |
      | MA_001 | P138 | AK_010_Vehicle_010, |
      | MD_001 | P139 | AK_011_Vehicle_011, |
      | ME_001 | P140 | AK_012_Vehicle_012, |
      | MS_001 | P141 | AK_005_Vehicle_005, |
      | NC_001 | P142 | AK_005_Vehicle_005, |
      | NJ_001 | P143 | AK_007_Vehicle_007, |
      | NY_001 | P144 | AK_008_Vehicle_008, |
      | SC_001 | P145 | AK_008_Vehicle_008, |
      | VA_001 | P146 | AK_010_Vehicle_010, |
      | FL_001 | P147 | AK_007_Vehicle_007, |
      | TX_001 | P148 | AK_012_Vehicle_012, |
      | GA_001 | P149 | AK_010_Vehicle_010, |
      | MI_001 | P150 | AK_011_Vehicle_011, |
      | ID_001 | P126 | AK_012_Vehicle_012, |

    @CarfaxUI
    Examples:
      | TC_ID  | user | effectiveDate |vehicle             |
      | ND_001 | P126 | 10/01/2024    |AK_005_Vehicle_005, |
  ...
  @NewBusiness @Endorsement @S8 @TC84928 @TC84971
  Scenario Outline: Carfax UI US42243 - S8 - Negative - New Business - Endorsement - "<TC_ID>"
    ...
    * I verify vehicle characteristics block is not displayed
    ...
    Examples:
      ...
      | AK_002 | P126 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | AR_002 | P127 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | AZ_002 | P128 | AK_006_Vehicle_006, | AK_007_Vehicle_007_ADD, |
      | CO_002 | P129 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | DC_002 | P130 | AK_006_Vehicle_006, | AK_009_Vehicle_009_ADD, |
      | IA_002 | P131 | AK_006_Vehicle_006, | AK_010_Vehicle_010_ADD, |
      | IL_002 | P132 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | IN_002 | P133 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | KS_002 | P134 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | KY_002 | P135 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | MN_002 | P136 | AK_006_Vehicle_006, | AK_007_Vehicle_007_ADD, |
      | MO_002 | P137 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | MT_002 | P138 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | ND_002 | P139 | AK_006_Vehicle_006, | ND_013_Vehicle_013_ADD, |
      | NE_002 | P140 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | NH_002 | P141 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | NM_002 | P142 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | NV_002 | P143 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | OH_002 | P144 | AK_006_Vehicle_006, | AK_007_Vehicle_007_ADD, |
      | OK_002 | P145 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | OR_002 | P146 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | PA_002 | P147 | AK_006_Vehicle_006, | AK_010_Vehicle_010_ADD, |
      | RI_002 | P148 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | SD_002 | P149 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | TN_002 | P150 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | UT_002 | P126 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | VT_002 | P127 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | WA_002 | P128 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | WI_002 | P129 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | WV_002 | P130 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | WY_002 | P131 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | AL_002 | P132 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | CA_002 | P133 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | CT_002 | P134 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | DE_002 | P135 | AK_006_Vehicle_006, | ND_013_Vehicle_013_ADD, |
      | HI_002 | P136 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | LA_002 | P137 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | MA_002 | P138 | AK_006_Vehicle_006, | AK_010_Vehicle_010_ADD, |
      | MD_002 | P139 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | ME_002 | P140 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | MS_002 | P141 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | NC_002 | P142 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | NJ_002 | P143 | AK_006_Vehicle_006, | AK_007_Vehicle_007_ADD, |
      | NY_002 | P144 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | SC_002 | P145 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | VA_002 | P146 | AK_006_Vehicle_006, | AK_010_Vehicle_010_ADD, |
      | FL_002 | P147 | AK_006_Vehicle_006, | AK_007_Vehicle_007_ADD, |
      | TX_002 | P148 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | GA_002 | P149 | AK_006_Vehicle_006, | AK_010_Vehicle_010_ADD, |
      | MI_002 | P150 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | ID_002 | P126 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |

  @NewBusiness @Renewal @S9 @TC84928 @TC84971
  Scenario Outline: Carfax UI US42243 - S9 - Negative - New Business - Renewal - "<TC_ID>" - "<effectiveDate>" on PDF
    ...
    * I set "Effective_Date" to "<effectiveDate>"
    ...
    Then I reload "us/US42243" vehicle data
    ...
    * I verify vehicle characteristics block is not displayed
    ...
    Examples:
      | TC_ID  | user | vehicle             | vehicleRNW              |
      | AK_003 | P126 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | AR_003 | P127 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | AZ_003 | P128 | AK_006_Vehicle_006, | AK_007_Vehicle_007_ADD, |
      | CO_003 | P129 | AK_006_Vehicle_006, | AK_007_Vehicle_007_ADD, |
      | DC_003 | P130 | AK_006_Vehicle_006, | AK_009_Vehicle_009_ADD, |
      | IA_003 | P131 | AK_006_Vehicle_006, | AK_010_Vehicle_010_ADD, |
      | IL_003 | P132 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | IN_003 | P133 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | KS_003 | P134 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | KY_003 | P135 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | MN_003 | P136 | AK_006_Vehicle_006, | AK_007_Vehicle_007_ADD, |
      | MO_003 | P137 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | MT_003 | P138 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | ND_003 | P139 | AK_006_Vehicle_006, | ND_013_Vehicle_013_ADD, |
      | NE_003 | P140 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | NH_003 | P141 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | NM_003 | P142 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | NV_003 | P143 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | OH_003 | P144 | AK_006_Vehicle_006, | AK_007_Vehicle_007_ADD, |
      | OK_003 | P145 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | OR_003 | P146 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | PA_003 | P147 | AK_006_Vehicle_006, | AK_010_Vehicle_010_ADD, |
      | RI_003 | P148 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | SD_003 | P149 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | TN_003 | P150 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | UT_003 | P126 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | VT_003 | P127 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | WA_003 | P128 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | WI_003 | P129 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | WV_003 | P130 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | WY_003 | P131 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | AL_003 | P132 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | CA_003 | P133 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | CT_003 | P134 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | DE_003 | P135 | AK_006_Vehicle_006, | ND_013_Vehicle_013_ADD, |
      | HI_003 | P136 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | LA_003 | P137 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | MA_003 | P138 | AK_006_Vehicle_006, | AK_010_Vehicle_010_ADD, |
      | MD_003 | P139 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | ME_003 | P140 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | MS_003 | P141 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | NC_003 | P142 | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      | NJ_003 | P143 | AK_006_Vehicle_006, | AK_007_Vehicle_007_ADD, |
      | NY_003 | P144 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | SC_003 | P145 | AK_006_Vehicle_006, | AK_008_Vehicle_008_ADD, |
      | VA_003 | P146 | AK_006_Vehicle_006, | AK_010_Vehicle_010_ADD, |
      | FL_003 | P147 | AK_006_Vehicle_006, | AK_007_Vehicle_007_ADD, |
      | TX_003 | P148 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |
      | GA_003 | P149 | AK_006_Vehicle_006, | AK_010_Vehicle_010_ADD, |
      | MI_003 | P150 | AK_006_Vehicle_006, | AK_011_Vehicle_011_ADD, |
      | ID_003 | P126 | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |

    @CarfaxUI
    Examples:
      | TC_ID  | user | effectiveDate | vehicle             | vehicleRNW              |
      | NH_003 | P126 | 11/15/2023    | AK_006_Vehicle_006, | AK_005_Vehicle_005_ADD, |
      ...
      | CA_003 | P133 | 12/16/2023    | AK_006_Vehicle_006, | AK_012_Vehicle_012_ADD, |

  @NewBusiness @Endorsement @OOS @S10 @TC84928 @TC84971
  Scenario Outline: Carfax UI US42243 - S10 - Negative - New Business - Endorsement - OOS - "<TC_ID>"
  ...
  @NewBusiness @Renewal @OOS @S11 @TC84928 @TC84971
  Scenario Outline: Carfax UI US42243 - S11 - Negative - New Business - Renewal - OOS - "<TC_ID>"
  ...
  @NewBusiness @Endorsement @Renewal @OOS @S12 @TC84928 @TC84971
  Scenario Outline: Carfax UI US42243 - S12 - Negative - New Business - Endorsement - Renewal - OOS - "<TC_ID>"
