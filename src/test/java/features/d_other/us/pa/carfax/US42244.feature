@PersonalAuto @US42244 @TF107 @TF880 @TF957
Feature: Carfax UI - Antique Vehicles

  As an underwriter I would like to see Vehicle Characteristics
  for Antique Vehicles so that better business
  insights to the vehicles we're adding into our books.

  @NewBusiness @S1 @TC84950 @TC84954
  Scenario Outline: Carfax UI US42244 - S1 - New Business - "<TC_ID>" - "<effectiveDate>" on PDF
  ...
  @NewBusiness @S1a
  Scenario Outline: Carfax UI US42244 - S1a - New Business - "<TC_ID>" - "<effectiveDate>" on day before PDF
  ...
  @NewBusiness @Endorsement @S2 @TC84951 @TC84955
  Scenario Outline: Carfax UI US42244 - S2 - New Business - Endorsement - "<TC_ID>"
  ...
  @NewBusiness @Renewal @S3 @TC84953 @TC84956
  Scenario Outline: Carfax UI US42244 - S3 - New Business - Renewal - "<TC_ID>" - "<effectiveDate>" on PDF
  ...
  Scenario Outline: Carfax UI US42244 - S3a - New Business - Renewal - "<TC_ID>" - "<effectiveDate>" on day before PDF
  ...
  @NewBusiness @Endorsement @OOS @S4 @TC84952 @TC84957
  Scenario Outline: Carfax UI US42244 - S4 - New Business - Endorsement - OOS - "<TC_ID>"
  ...
  @NewBusiness @Renewal @OOS @S5 @TC84957
  Scenario Outline: Carfax UI US42244 - S5 - New Business - Renewal - OOS - "<TC_ID>"
  ...
  @NewBusiness @Endorsement @Renewal @OOS @S6 @TC84957
  Scenario Outline: Carfax UI US42244 - S6 - New Business - Endorsement - Renewal - OOS - "<TC_ID>"
  ...
  @NewBusiness  @S7 @TC84958
  Scenario Outline: Carfax UI US42244 - S7 - Negative - New Business - "<TC_ID>" - "<effectiveDate>" on PDF

    Given I have entered test data for test case "<TC_ID>" in excel workbook "us/US42244" in sheet "QuoteCreatorPA" for "PA" LOB
    * I set "Additional_Vehicles" to "<vehicle>"
    * I set "Effective_Date" to "<effectiveDate>"
    * I reload "us/US42244" vehicle data
  ...
  @NewBusiness @Endorsement @S8 @TC84958
  Scenario Outline: Carfax UI US42244 - S8 - Negative - New Business - Endorsement - "<TC_ID>"
  ...
  @NewBusiness @Renewal @S9 @TC84958
  Scenario Outline: Carfax UI US42244 - S9 - Negative - New Business - Renewal - "<TC_ID>" - "<effectiveDate>" on PDF
    ...
    * I set "Effective_Date" to "<effectiveDate>"
    ...
    Then I reload "us/US42244" vehicle data
  ...
  @NewBusiness @Endorsement @OOS @S10 @TC84958
  Scenario Outline: Carfax UI US42244 - S10 - Negative - New Business - Endorsement - OOS - "<TC_ID>"
  ...
  @NewBusiness @Renewal @OOS @S11 @TC84958
  Scenario Outline: Carfax UI US42244 - S11 - Negative - New Business - Renewal - OOS - "<TC_ID>"
  ...
  @NewBusiness @Endorsement @Renewal @OOS @S12 @TC84958
  Scenario Outline: Carfax UI US42244 - S12 - Negative - New Business - Endorsement - Renewal - OOS - "<TC_ID>"
