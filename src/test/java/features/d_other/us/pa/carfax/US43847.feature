@PersonalAuto @US43847
Feature: Change Request - Carfax UI for Collector Cars

  As an Underwriting Manager, I do not want "Original Agreed Value" field to be visible
  in the Vehicles Details section of the UI Vehicle for Collector Cars
  (Exotic, Classic and Antique Cars) as the newly created "Market Value"
  field is serving the purpose.

  @NewBusiness @Endorsement @Renewal @OOS @S1
  Scenario Outline: New Business Effective Date - "<testCaseDataID>"

    Given I have entered test data for test case "<testCaseDataID>" in excel workbook "us/US43847" in sheet "QuoteCreatorPA" for "PA" LOB
    ...
    * I verify that "Original Agreed Value$" input "1" is not visible
  ...
  Scenario Outline: Renewal Business Effective Date - "<testCaseDataID>"
    ...
    * I create a new "PA" quote
    ...
    Then I navigate to "Coverages" page
    * I navigate to previous page
    * I verify that "Original Agreed Value$" input "1" is visible
