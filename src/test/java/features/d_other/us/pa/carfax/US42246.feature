@PersonalAuto @US42246 @TF107 @TF880 @TF960
Feature: Carfax UI - Classic Vehicles

  As an underwriter I would like to see Vehicle Characteristics
  for Classic Vehicles so that better business
  insights to the vehicles we're adding into our books.

  @NewBusiness @S1 @TC84905 @TC84909 @TC84910
  Scenario Outline: Carfax UI US42246 - S1 - New Business - "<TC_ID>" - "<effectiveDate>" on PDF

    Given I have entered test data for test case "<TC_ID>" in excel workbook "us/US42246" in sheet "QuoteCreatorPA" for "PA" LOB
    ...
    * I verify vehicle characteristics block is displayed with
    ...
    @ClassicCollectors @CarfaxUI
    Examples:
      | TC_ID  | user | effectiveDate |
      | NV_001 | P126 | 10/01/2024    |
  ...
  @NewBusiness @S1a
  Scenario Outline: Carfax UI US42246 - S1a - New Business - "<TC_ID>" - "<effectiveDate>" on day before PDF
  ...
  @NewBusiness @Endorsement @S2 @TC84906 @TC84909 @TC84910
  Scenario Outline: Carfax UI US42246 - S2 - New Business - Endorsement - "<TC_ID>"
  ...
  @NewBusiness @Renewal @S3 @TC84907 @TC84909 @TC84910
  Scenario Outline: Carfax UI US42246 - S3 - New Business - Renewal - "<TC_ID>" - "<effectiveDate>" on PDF
  ...
  Scenario Outline: Carfax UI US42246 - S3a - New Business - Renewal - "<TC_ID>" - "<effectiveDate>" on day before PDF
  ...
  @NewBusiness @Endorsement @OOS @S4 @TC84908 @TC84909 @TC84910
  Scenario Outline: Carfax UI US42246 - S4 - New Business - Endorsement - OOS - "<TC_ID>"
  ...
  @NewBusiness @Renewal @OOS @S5 @TC84908 @TC84909 @TC84910
  Scenario Outline: Carfax UI US42246 - S5 - New Business - Renewal - OOS - "<TC_ID>"
  ...
  @NewBusiness @Endorsement @Renewal @OOS @S6 @TC84908 @TC84909 @TC84910
  Scenario Outline: Carfax UI US42246 - S6 - New Business - Endorsement - Renewal - OOS - "<TC_ID>"
  ...
  @NewBusiness  @S7 @TC84912
  Scenario Outline: Carfax UI US42246 - S7 - Negative - New Business - "<TC_ID>" - "<effectiveDate>" on PDF
    ...
    * I set "Effective_Date" to "<effectiveDate>"
    * I reload "us/US42246" vehicle data
  ...
  @NewBusiness @Endorsement @S8 @TC84912
  Scenario Outline: Carfax UI US42246 - S8 - Negative - New Business - Endorsement - "<TC_ID>"
  ...
  @NewBusiness @Renewal @S9 @TC84912
  Scenario Outline: Carfax UI US42246 - S9 - Negative - New Business - Renewal - "<TC_ID>" - "<effectiveDate>" on PDF
  ...
  @NewBusiness @Endorsement @OOS @S10 @TC84912
  Scenario Outline: Carfax UI US42246 - S10 - Negative - New Business - Endorsement - OOS - "<TC_ID>"
  ...
  @NewBusiness @Renewal @OOS @S11 @TC84912
  Scenario Outline: Carfax UI US42246 - S11 - Negative - New Business - Renewal - OOS - "<TC_ID>"
  ...
  @NewBusiness @Endorsement @Renewal @OOS @S12 @TC84912
  Scenario Outline: Carfax UI US42246 - S12 - Negative - New Business - Endorsement - Renewal - OOS - "<TC_ID>"
