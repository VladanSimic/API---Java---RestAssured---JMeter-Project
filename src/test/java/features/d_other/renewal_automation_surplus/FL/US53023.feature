@HomeownersSurplus @US53023 @RenewalAutomation
Feature: HS FL - Renewal Automation - Implementation of New Form and DocuSign Configuration - Bind Request Form

  @US53023
  Scenario:TC_01 FL_001 | Verify that the new Bind Request in generated and attached to eSign package with 'Renewal Offer batch'
...
#    * I set "Underwriting_Company_Underwriting_Company" to "PURE Specialty Exchange"
    ...
    * I download the file "Bind Request" and verify keywords
      | PP-ABE-GEN-001 (04/2025)                                                                                                                                                                |
      | Insured Name(s) {Customer}                                                                                                                                                              |
      | Line of Coverage Homeowners                                                                                                                                                             |
      | Policy Effective Date {EffectiveDate}                                                                                                                                                   |
      | On behalf of my client, the insured listed above, please bind the proposal/offer of coverage to which this bind request is appended and issue the policy offered through PURE Programs. |
      | Producer Name                                                                                                                                                                           |
      | Producer Signature                                                                                                                                                                      |
      | Agency Name Underc0de                                                                                                                                                                   |
    ...
    * I download the file "Document Link" with index 2 and verify keywords
      | PP-ABE-GEN-001 (04/2025)                                                                                                                                                                |
      | Insured Name(s) {Customer}                                                                                                                                                              |
      | Line of Coverage Homeowners                                                                                                                                                             |
      | Policy Effective Date {EffectiveDate}                                                                                                                                                   |
  ...
  @US53023
  Scenario:TC_02 FL_001 | Verify that the new Bind Request in generated and attached to eSign package with 'Send Renewal Offer' button
    Given I use "FL_001" regression test data from "QuoteCreatorHS" sheet
