@HomeownersSurplus @US51374 @RenewalAutomation
Feature: HS FL -  Renewal Automation - DocuSign - Ability to manually resend documents/envelopes

  @US51374
  Scenario:TC_01 | Verify that document packages present under the eSign Package - Document Tracking block, documents/packages can be to be manually resent for HS FL renewals- UW
...
#      | checkbox       | eSign Package 2    |              | Today               | sent                  | StatementOfDiligentEffortForm - Florida    | Document Link | No                      |                       |
    ...
    * I click "View History" with index 1
    ...
    And I verify eSign History block
      ...
      | 5   | PURE Insurance received a printable copy of the envelope                             | Today | sent    |
      |6   | The envelope has been voided and e-mail notifications were sent [ ]                  | Today | voided  |
  ...
  @US51374
  Scenario:TC_02 | Verify that document packages present under the eSign Package - Document Tracking block, documents/packages can be to be manually resent for HS FL renewals- Broker
    Given I use "FL_001" regression test data from "QuoteCreatorHS" sheet
...
#      | checkbox       | eSign Package 2    |              | Today               | sent                  | StatementOfDiligentEffortForm - Florida    | Document Link | No                      |                       |
  ...
  @US51374
  Scenario:TC_03 | Verify that if there are changes on renewal transaction and renewal offer generated, package will be voided( renewed premium), new one generated and sent (Send Renewal Offer button)
    Given I use "FL_001" regression test data from "QuoteCreatorHS" sheet
...
#      | checkbox       | eSign Package 1    |              | Today               | sent                  | StatementOfDiligentEffortForm - Florida    | Document Link | No                      |                       |
    ...
    * I go to summary and click update renewal
    Then I write text to "Replacement Cost" and value is "8800000"
...
#      | checkbox       | eSign Package 2    |              | Today               | sent                  | StatementOfDiligentEffortForm - Florida    | Document Link | No                      |                       |
    ...
    * I click "View History" with index 1
    ...
    And I verify eSign History block
      ...
      | 3   | PURE Insurance sent an invitation to Nemanja Pecic [npecic@pureinsurance.com Signer]                                                                                      | Today | sent    |
      | 4   | PURE Insurance received a printable copy of the envelope                                                                                                                  | Today | sent    |
      | 5   | The envelope has been voided and e-mail notifications were sent [The envelope has been voided and e-mail notifications were sent [Changes have been made to the renewal.] | Today | voided  |
    ...
    * I click "View History" with index 2
    ...
    Then I click "eSignature packages"
    * I think for 3 to 4 seconds
    * I download the file "Document Link" with index 1 and verify keywords
      | Grand Total ${grandTotalRN} |

  @US51374
  Scenario:TC_04 | Verify once package is voided and re-sent, the correct renewal offer is displayed on application page
    Given I use "FL_001" regression test data from "QuoteCreatorHS" sheet
