@HomeownersSurplus @US54564 @RenewalAutomation @UI @ProgramsRequiredForms
Feature: Programs Renewal Automation - DocuSign UI - Signature Preference Block

  @US45464 @FullRegression_DreamTeam @UI @RenewalAutomation @Disabled
  Scenario:TC_01 | Verify that the new tab 'Programs Required Forms' tab is created on customer level and is located between  "required forms" and "documents" and is visible both to Internal User and Broker
  ...
  @US45464 @FullRegression_DreamTeam @UI @RenewalAutomation @Disabled
  Scenario:TC_02 | Verify that correct Member, Advisor/Servicer, and Producer emails are visible and editable in the 'Signature Preference' section for internal users
    ...
    * I think for 5 to 6 seconds
    ...
    Then I verify that field "Member Email Address for electronic signature" has value "npecic@pureinsurance.com"
    And I verify field "Member Email Address for electronic signature" is "editable"

    Then I verify that field "Advisor / Servicer Email Address for electronic signature" has value "mnikolic@pureinsurance.zcom"
    And I verify field "Advisor / Servicer Email Address for electronic signature" is "editable"

    Then I verify that field "Licensed Producer Email Address for electronic signature" has value ""
    And I verify field "Licensed Producer Email Address for electronic signature" is "editable"


  @US45464
  Scenario:TC_03 | Verify that correct Member, Advisor/Servicer, and Producer emails are visible and editable in the 'Signature Preference' section for broker users.
  ...
  @US45464
  Scenario:TC_04 | Verify that if member email is changed on ProgramsRequiredForms tab, it's not changed on summary page
    ...
    * I write text to "Member Email Address for electronic signature" and value is "mnikolic@pureinsurance.zcom"
    Then I click "summary"

    * I verify if element with message "mnikolic@pureinsurance.zcom" is "Not Displayed" on the UI

    * I verify if element with message "npecic@pureinsurance.com" is "Displayed" on the UI


  @US45464 @Disabled
  Scenario:TC_05 | Verify that the new tab 'Programs Required Forms' tab is not Visible for Account that has PA policy
    ...
    * I accept underwriting referrals
    ...
    And I think for 30 to 45 seconds
    Then I verify if element with message "Renewal" is "Displayed" on the UI
  ...
  @US45464 @Disabled
  Scenario:TC_06 | Verify that the new tab 'Programs Required Forms' tab is not Visible for Account that has CO policy
  ...
  @US45464 @Disabled
  Scenario:TC_07 | Verify that the new tab 'Programs Required Forms' tab is not Visible for Account that has CC policy
    ...
    * I navigate to transactions or endorsements
    ...
    And I think for 30 to 45 seconds
    * I navigate to transactions or endorsements
    Then I verify if element with message "Policy Extension" is "Displayed" on the UI
  ...
  @US45464 @Disabled
  Scenario:TC_08 | Verify that the new tab 'Programs Required Forms' tab is not Visible for Account that has EX policy
  ...
  @US45464 @Disabled
  Scenario:TC_09 | Verify that the new tab 'Programs Required Forms' tab is not Visible for Account that has ES policy
  ...
  @US45464 @Disabled
  Scenario:TC_09 | Verify that the new tab 'Programs Required Forms' tab is not Visible for Account that has HO policy
  ...
  @US45464 @Disabled
  Scenario:TC_10 | Verify that the new tab 'Programs Required Forms' tab is Visible for Account when HS FL policy is added to Account
    Given I use "FL_001" regression test data from "QuoteCreatorHO" sheet
