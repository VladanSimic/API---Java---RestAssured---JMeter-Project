...
public class QuoteListBlock extends CommonComponentsAndActions {
    WebDriver driver;

    public QuoteListBlock(WebDriver driver) {
        super(driver);
        this.driver = driver;
        PageFactory.initElements(driver, this);
    }

    @FindBy(xpath = "//div[contains(text(),'quote list')]/../../../../../..//span[text()='Account ID']")
    WebElement accountIDHeader;
    @FindBy(xpath = "//div[contains(text(),'quote list')]/../../../../../..//span[text()='Account ID']/../../../../div[2]")
    ...
    public void searchQuoteByHHID(String hhid) throws InterruptedException {
        ...
        pause(3000);
        clickElement(driver.findElement(By.xpath("//div[contains(text(),'" + hhid + "')]/../../td[2]/../td[5]//span")), "HHID: " + hhid);
    }
